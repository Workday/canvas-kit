...
echo "==========================================================================="
echo ""
echo "For EACH package below, configure 3 trusted publishers on npm:"
echo ""
echo "Trusted Publisher #1: publish.yml"
echo "  Provider: GitHub Actions"
echo "  Repository: Workday/canvas-kit"
echo "  Workflow: publish.yml"
echo "  Environment: (leave blank)"
echo ""
echo "Trusted Publisher #2: release-minor.yml"
echo "  Provider: GitHub Actions"
echo "  Repository: Workday/canvas-kit"
echo "  Workflow: release-minor.yml"
echo "  Environment: (leave blank)"
echo ""
echo "Trusted Publisher #3: release-major.yml"
echo "  Provider: GitHub Actions"
echo "  Repository: Workday/canvas-kit"
echo "  Workflow: release-major.yml"
echo "  Environment: (leave blank)"
echo ""
echo "==========================================================================="
echo ""
...
echo "Each package needs 3 trusted publishers configured (39 total configurations)"
echo "==========================================================================="
