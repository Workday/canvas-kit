...
export default create({
  ...
  // Branding
  brandImage: null,
  brandTitle: `<div class="canvas-kit-brand">
    <svg class="canvas-kit-brand-logo" width="40" height="40" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class="canvas-kit-brand-text">
      <span class="canvas-kit-brand-title">Canvas Kit</span>
      <span class="canvas-kit-brand-version">v${version}</span>
    </div>
  </div>`,
