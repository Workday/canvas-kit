...
`;const c=()=>e.jsx(I,{dir:"rtl",children:e.jsx(l,{})});c.__RAW__=`import React from 'react';
...
`;function g(t){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...y(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(w,{of:Q}),`
`,e.jsx(n.h1,{id:"canvas-kit-loading-sparkles",children:"Canvas Kit Loading Sparkles"}),`
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"LoadingSparkles"})," is a loading animation that makes users aware an AI operation is in progress."]}),`
...
`,e.jsxs(n.p,{children:[e.jsx(n.code,{children:"LoadingSparkles"}),` is designed to work out-of-the-box, but you'll need to add some wiring for screen
readers. In the example below, we're simulating a loading state with a `,e.jsx(n.code,{children:"setTimeout"}),` that's triggered
when the "Generate Quote" button is clicked.`]}),`
`,e.jsxs(n.p,{children:["The ARIA live region uses the ",e.jsx(n.code,{children:"aria-label"})," on ",e.jsx(n.code,{children:"LoadingSparkles"}),` to announce the loading state. And
it uses the text in `,e.jsx(n.code,{children:"AccessibleHide"}),` to announce when loading is complete. In a real-world
...
readers.`]}),`
`,e.jsx(n.h4,{id:"consolidating-aria-live-regions",children:"Consolidating ARIA Live Regions"}),`
`,e.jsxs(n.p,{children:["In the example, we wrapped ",e.jsx(n.code,{children:"LoadingSparkles"})," inside our ",e.jsx(n.code,{children:"AriaLiveRegion"}),` component, but in general
...
`,e.jsx(b,{name:"LoadingSparkles",fileName:"/preview-react/"})]})}function N(t={}){const{wrapper:n}={...y(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(g,{...t})}):g(t)}const Q={title:"Preview/Loading Sparkles (AI)",component:l,tags:["autodocs"],parameters:{docs:{page:N}}},a={render:d},r={render:c};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: BasicExample
}`,...a.parameters?.docs?.source}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: RTLExample
}`,...r.parameters?.docs?.source}}};const gn=["Basic","RTL"];export{a as Basic,r as RTL,gn as __namedExportsOrder,Q as default};
