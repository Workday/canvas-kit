...
`;const v=()=>{const r=G(),{id:n}=A(r);return e.jsxs(t,{model:r,children:[e.jsx(t.Label,{children:"Email"}),e.jsxs(t.Field,{as:d,children:[e.jsx(d.InnerStart,{children:e.jsx(V,{icon:P})}),e.jsx(d.Input,{id:n,autoComplete:"email"}),e.jsx(d.InnerEnd,{children:e.jsx(d.ClearButton,{})})]})]})};v.__RAW__=`import React from 'react';
