...
`;const I=()=>{const[s,t]=o.useState("");return e.jsxs(n,{onSelect:r=>t(r.id),children:[e.jsx(n.TargetContext,{children:"Right-click to Open Menu"}),e.jsx(n.Popper,{children:e.jsx(n.Card,{children:e.jsxs(n.List,{children:[e.jsx(n.Item,{children:"First Item"}),e.jsx(n.Item,{children:"Second Item"}),e.jsx(n.Item,{children:"Third Item (with a really, really, really long label)"}),e.jsx(n.Item,{children:"Fourth Item"})]})})}),e.jsxs(a,{size:"small",marginTop:"s",children:["Selected: ",e.jsx("span",{"data-testid":"output",children:s})]})]})};I.__RAW__=`import React from 'react';
...
`;const M=()=>{const[s,t]=o.useState("");return e.jsx(e.Fragment,{children:e.jsxs(n,{onSelect:r=>t(r.id),children:[e.jsx(n.Target,{children:"Open Menu"}),e.jsx(n.Popper,{children:e.jsx(n.Card,{children:e.jsxs(n.List,{children:[e.jsxs(n.Group,{title:"First Group",children:[e.jsx(n.Item,{children:"First Item"}),e.jsx(n.Item,{children:"Second Item"})]}),e.jsxs(n.Group,{title:"Second Group",children:[e.jsx(n.Item,{children:"Third Item (with a really, really, really long label)"}),e.jsx(n.Item,{"aria-disabled":!0,children:"Fourth Item"})]})]})})}),e.jsxs(a,{size:"small",marginTop:"s",children:["Selected: ",e.jsx("span",{"data-testid":"output",children:s})]})]})})};M.__RAW__=`import React from 'react';
...
`;const y=()=>{const[s,t]=o.useState("");return e.jsxs(n,{onSelect:r=>t(r.id),children:[e.jsx(n.Target,{children:"Open Menu"}),e.jsx(n.Popper,{children:e.jsx(n.Card,{children:e.jsxs(n.List,{children:[e.jsxs(n.Item,{"data-text":"First Item",children:[e.jsx(n.Item.Icon,{icon:f}),e.jsx(n.Item.Text,{children:"First Item"})]}),e.jsxs(n.Item,{"data-text":"Second Item (with a really really really long label)",children:[e.jsx(n.Item.Icon,{icon:A}),e.jsx(n.Item.Text,{children:"Second Item (with a really really really long label)"})]}),e.jsxs(n.Item,{"aria-disabled":!0,"data-text":"Third Item",children:[e.jsx(n.Item.Icon,{icon:f}),e.jsx(n.Item.Text,{children:"Third Item"}),e.jsx(n.Item.Icon,{icon:g})]}),e.jsxs(n.Item,{"data-text":"User",children:[e.jsx(n.Item.Icon,{icon:P}),e.jsx(n.Item.Text,{children:"User"})]}),e.jsx(n.Divider,{}),e.jsxs(n.Item,{"data-text":"Fifth Item (with divider)",children:[e.jsx(n.Item.Icon,{icon:g}),e.jsx(n.Item.Text,{children:"Fifth Item (with divider)"})]})]})})}),e.jsxs(a,{size:"small",marginTop:"s",children:["Selected: ",e.jsx("span",{"data-testid":"output",children:s})]})]})};y.__RAW__=`import React from 'react';
...
`;const B=[{id:"first-item",label:"First Item"},{id:"second-item",label:"Second Item",type:"submenu",children:[{id:"first-sub-item",label:"First Sub Item"},{id:"second-sub-item",label:"Second Sub Item",type:"submenu",children:[{id:"first-sub-sub-item",label:"First Sub Sub Item"},{id:"second-sub-sub-item",type:"submenu",label:"Second Sub Sub Item",children:[{id:"first-sub-sub-sub-item",label:"First Sub Sub Sub Item"},{id:"second-sub-sub-sub-item",label:"Second Sub Sub Sub Item"},{id:"third-sub-sub-sub-item",label:"Third Sub Sub Sub Item"},{id:"fourth-sub-sub-sub-item",label:"Fourth Sub Sub Sub Item"}]},{id:"third-sub-sub-item",label:"Third Sub Sub Item"},{id:"fourth-sub-sub-item",label:"Fourth Sub Sub Item"}]},{id:"third-sub-item",label:"Third Sub Item"},{id:"fourth-sub-item",label:"Fourth Sub Item"}]},{id:"third-item",label:"Third Item"},{id:"fourth-item",label:"Fourth Item"}],S=()=>{const[s,t]=o.useState("");function r(i){return i.type==="submenu"?e.jsxs(n.Submenu,{id:i.id,items:i.children,children:[e.jsx(n.Submenu.TargetItem,{children:i.label}),e.jsx(n.Submenu.Popper,{children:e.jsx(n.Submenu.Card,{children:e.jsx(n.Submenu.List,{children:r})})})]}):e.jsx(n.Item,{children:i.label})}return e.jsxs(n,{items:B,id:"first-menu",getTextValue:i=>i.label,onSelect:i=>{t(i.id)},children:[e.jsx(n.Target,{children:"Open Menu"}),e.jsx(n.Popper,{children:e.jsx(n.Card,{children:e.jsx(n.List,{children:r})})}),e.jsxs(a,{size:"small",cs:{marginTop:_.md},children:["Selected: ",e.jsx("span",{"data-testid":"output",children:s})]})]})};S.__RAW__=`import React from 'react';
...
`;function T(s){const t={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...w(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(k,{of:O}),`
...
}`,...b.parameters?.docs?.source}}};const G=["Basic","Grouping","ContextMenu","Icons","SelectableMenu","Nested","NestedDynamic"];export{u as Basic,c as ContextMenu,l as Grouping,m as Icons,p as Nested,b as NestedDynamic,h as SelectableMenu,G as __namedExportsOrder,R as default};
