...
`;const Y=["Shoes","Pants","Dress Shoes","Color","Accessories","Luxury","Casual","Hats","Beanies","Glasses","Jewelry"],F=c({display:"flex",flexWrap:"wrap",gap:d.sm}),R=()=>{const[l,t]=p.useState(Y);return e.jsx("div",{className:F,children:l.map((I,L)=>e.jsxs(r,{variant:"removable",children:[e.jsx(r.Label,{children:I}),e.jsx(r.IconButton,{"aria-label":"Remove",onClick:()=>t(l.filter(_=>_!==I))})]},L))})};R.__RAW__=`import React from 'react';
...
`;const G=z({base:{[i.vars.background]:h,[i.vars.border]:a,[i.vars.label]:s.fg.inverse,[m.vars.color]:s.fg.inverse,[n.vars.backgroundColor]:h,[n.vars.borderColor]:h,"&:hover, &.hover":{[i.vars.background]:a,[i.vars.label]:s.fg.inverse,[n.vars.backgroundColor]:a,[m.vars.color]:s.fg.inverse,[n.vars.borderColor]:a},"&:active, &.active":{[i.vars.background]:a,[i.vars.label]:s.fg.inverse,[m.vars.color]:s.fg.inverse,[n.vars.backgroundColor]:a},"&:focus, &.focus, &:focus-visible":{[i.vars.background]:a,[i.vars.label]:s.fg.inverse,[m.vars.color]:s.fg.inverse,[n.vars.backgroundColor]:a},"&:disabled, &.disabled":{[i.vars.background]:h,[i.vars.label]:s.fg.inverse,[m.vars.color]:s.fg.inverse}}}),T=()=>e.jsx("div",{children:e.jsxs(r,{cs:G(),children:[e.jsx(r.Icon,{"aria-label":"Add user"}),e.jsx(r.Label,{children:"Custom Pill Color"}),e.jsx(r.Count,{children:"10"})]})});T.__RAW__=`import {systemIconStencil} from '@workday/canvas-kit-react/icon';
