...
is an object that looks like `,e.jsx(n.code,{children:"{'data-part': partValue}"}),`. That object also has a non-enumerable
`,e.jsx(n.code,{children:"selector"})," property (",e.jsx(n.code,{children:'[data-part="{partValue}"]'}),`) for targeting the part from another stencil's
...
`})}),`
`,e.jsxs(n.p,{children:["To target a part from another stencil, use ",e.jsx(n.code,{children:".selector"}),`. Spreading the part onto an element still
only applies `,e.jsx(n.code,{children:"data-part"}),"."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-jsx",children:`const cardStencil = createStencil({
  base: {
