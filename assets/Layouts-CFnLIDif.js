...
`;const j=h({vars:{backgroundColor:""},base:({backgroundColor:o})=>({height:i(120),backgroundColor:o,p:{textAlign:"center",color:n.fg.inverse,fontWeight:f.bold}})}),J=d({gridTemplateColumns:"4fr 2fr 6fr",gridGap:s.md}),$=()=>e.jsxs(e.Fragment,{children:[e.jsx(x,{size:"medium",children:"Custom Column Width"}),e.jsxs(l,{cs:J,children:[e.jsx(r,{cs:j({backgroundColor:C}),children:e.jsx(a,{size:"small",children:"4 column width"})}),e.jsx(r,{cs:j({backgroundColor:S}),children:e.jsx(a,{size:"small",children:"2 column width"})}),e.jsx(r,{cs:j({backgroundColor:w}),children:e.jsx(a,{size:"small",children:"6 column width"})})]})]});$.__RAW__=`import * as React from 'react';
