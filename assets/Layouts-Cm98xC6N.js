...
`;const j=h({vars:{backgroundColor:""},base:({backgroundColor:o})=>({height:i(120),backgroundColor:o,p:{textAlign:"center",color:n.fg.inverse,fontWeight:f.bold}})}),Z=d({gridTemplateColumns:"4fr 2fr 6fr",gridGap:s.md}),$=()=>e.jsxs(e.Fragment,{children:[e.jsx(x,{size:"medium",children:"Custom Column Width"}),e.jsxs(l,{cs:Z,children:[e.jsx(r,{cs:j({backgroundColor:C}),children:e.jsx(a,{size:"small",children:"4 column width"})}),e.jsx(r,{cs:j({backgroundColor:S}),children:e.jsx(a,{size:"small",children:"2 column width"})}),e.jsx(r,{cs:j({backgroundColor:w}),children:e.jsx(a,{size:"small",children:"6 column width"})})]})]});$.__RAW__=`import * as React from 'react';
...
`;const J=d({gridTemplateAreas:"'Heading Heading Heading' 'FormLeft FormCenter FormRight'",gridAutoRows:"min-content",gridRowGap:s.sm,gridColumnGap:s.xxl}),N=h({vars:{gridArea:""},base:({gridArea:o})=>({paddingInline:m.sm,border:`${i(1)} solid ${n.brand.border.primary}`,gridArea:o})}),O=h({vars:{gridArea:""},base:({gridArea:o})=>({paddingInline:m.md,border:`${i(1)} dashed ${n.brand.border.primary}`,gridArea:o})}),v=()=>e.jsxs(l,{cs:J,children:[e.jsx(r,{cs:N({gridArea:"Heading"}),children:e.jsx(x,{size:"medium",children:"Full Width With 3 Columns"})}),e.jsx(B,{area:"FormLeft",text:"Form - Left Third"}),e.jsx(B,{area:"FormCenter",text:"Form - Center Third"}),e.jsx(B,{area:"FormRight",text:"Form - Right Third"})]}),B=({area:o,text:t})=>e.jsxs(r,{cs:O({gridArea:o}),children:[e.jsx(a,{size:"small",fontWeight:"bold",children:t}),Array.from({length:5}).map(()=>e.jsxs(l,{cs:{gridGap:s.sm,marginBlockEnd:i(20)},children:[e.jsx(r,{cs:{backgroundColor:n.surface.default,width:i(120),height:i(12)}}),e.jsx(r,{cs:{border:`${i(1)} solid ${n.brand.border.primary}`,width:"100%",height:i(20)}})]}))]});v.__RAW__=`import * as React from 'react';
...
`;const U=d({gridTemplateAreas:"'Heading Heading Heading'",gridTemplateColumns:"repeat(3, 1fr)",gridAutoRows:"min-content",gridRowGap:s.sm,gridColumnGap:s.xl}),Y=d({gridArea:"Heading",paddingInline:m.sm,border:`${i(1)} solid ${n.brand.border.primary}`}),z=()=>e.jsxs(l,{cs:U,children:[e.jsx(r,{cs:Y,children:e.jsx(x,{size:"medium",children:"Full Width With 3 Columns and 2 Rows"})}),e.jsx(y,{}),e.jsx(y,{}),e.jsx(y,{}),e.jsx(y,{}),e.jsx(y,{}),e.jsx(y,{})]}),ee=d({border:`${i(1)} dashed ${n.brand.border.primary}`,paddingInline:m.md}),re=d({gridGap:s.md,marginBlockEnd:s.lg,"> *:first-child":{width:i(120),height:g.xxs,backgroundColor:n.surface.alt.default},"> *:last-child":{border:`${i(1)} solid ${n.border.default}`,width:"100%",height:g.xxs}}),y=o=>e.jsxs(r,{cs:ee,...o,children:[e.jsx(a,{size:"small",cs:{fontWeight:f.bold},children:"Form Block"}),Array.from({length:3}).map(()=>e.jsxs(l,{cs:re,children:[e.jsx(r,{}),e.jsx(r,{})]}))]});z.__RAW__=`import * as React from 'react';
...
`,e.jsx(c,{code:I})]})}function _r(o={}){const{wrapper:t}={...R(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(T,{...o})}):T(o)}export{_r as default};
