...
`,e.jsxs(n.p,{children:[`Canvas Kit doesn't include fonts by default. See our
`,e.jsx(n.a,{href:"https://workday.github.io/canvas-kit/?path=/docs/guides-fonts--docs",children:"Fonts guide"}),` for setup
...
`,e.jsxs(n.p,{children:["Update your root ",e.jsx(n.code,{children:"index.js"})," file to import Canvas Kit's design tokens."]}),`
...
root.render(<App />);
`})}),`
`,e.jsxs(n.p,{children:["Set ",e.jsx(n.code,{children:'data-theme="sana-canvas"'})," on ",e.jsx(n.code,{children:"<html>"})," in your ",e.jsx(n.code,{children:"index.html"}),":"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-html",children:`<html lang="en" data-theme="sana-canvas"></html>
`})}),`
`,e.jsxs(n.p,{children:["Then in your ",e.jsx(n.code,{children:"App.js"})," you can wrap your application with ",e.jsx(n.code,{children:"CanvasProvider"}),"."]}),`
...
`})}),`
`,e.jsxs(n.p,{children:["If you cannot control ",e.jsx(n.code,{children:"<html>"})," (embedded apps, microfrontends), pass ",e.jsx(n.code,{children:"sanaCanvasProviderTheme"}),`
instead so menus, selects, and other popups still get Sana brand variables:`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-jsx",children:`import {CanvasProvider, sanaCanvasProviderTheme} from '@workday/canvas-kit-react/common';
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://workday.github.io/canvas-kit/?path=/docs/guides-upgrade-guides-v15-0-overview--docs",children:"v15.0 Upgrade Guide"})}),`
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://workday.github.io/canvas-kit/?path=/docs/guides-upgrade-guides-v16-0-overview--docs",children:"v16.0 Upgrade Guide"})}),`
`]}),`
`]}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"https://workday.github.io/canvas-kit/?path=/docs/guides-fonts--docs",children:"Fonts"})}),`
`]}),`
`]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Builds by ",e.jsx(n.a,{href:"https://docs.github.com/en/actions",children:"Github Actions"})]})]})}function o(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}function t(s){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Guides/Getting Started"}),`
`,e.jsx(o,{})]})}function v(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(t,{...s})}):t()}export{v as default};
