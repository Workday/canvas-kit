...
`;let S="";const P=s({gap:u.md,alignItems:"center"}),I=()=>{const[n,t]=l.useState("");function a(o){t(o.target.value)}function r(o){o.preventDefault(),S=n,t("")}return e.jsxs(e.Fragment,{children:[e.jsxs(x,{as:"form","aria-label":"Hidden Live Region",onSubmit:r,cs:P,children:[e.jsxs(i,{children:[e.jsx(i.Label,{children:"Type your message:"}),e.jsx(i.Input,{as:v,onChange:a,value:n})]}),e.jsx(A,{type:"submit",children:"Send Message"})]}),e.jsx(m,{children:e.jsx(k,{as:L,children:S})})]})};I.__RAW__=`import React from 'react';
...
`]}),`
`,e.jsx(d,{code:M})]})}function wt(n={}){const{wrapper:t}={...w(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(F,{...n})}):F(n)}export{wt as default};
