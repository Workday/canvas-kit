...
`;const j=h({vars:{backgroundColor:""},base:({backgroundColor:o})=>({height:i(120),backgroundColor:o,p:{textAlign:"center",color:n.fg.inverse,fontWeight:f.bold}})}),q=d({gridTemplateColumns:"4fr 2fr 6fr",gridGap:s.md}),$=()=>e.jsxs(e.Fragment,{children:[e.jsx(x,{size:"medium",children:"Custom Column Width"}),e.jsxs(l,{cs:q,children:[e.jsx(r,{cs:j({backgroundColor:C}),children:e.jsx(a,{size:"small",children:"4 column width"})}),e.jsx(r,{cs:j({backgroundColor:S}),children:e.jsx(a,{size:"small",children:"2 column width"})}),e.jsx(r,{cs:j({backgroundColor:w}),children:e.jsx(a,{size:"small",children:"6 column width"})})]})]});$.__RAW__=`import * as React from 'react';
...
`;const N=d({gridTemplateAreas:"'Heading Heading Heading' 'FormLeft FormCenter FormRight'",gridAutoRows:"min-content",gridRowGap:s.sm,gridColumnGap:s.xxl}),O=h({vars:{gridArea:""},base:({gridArea:o})=>({paddingInline:m.sm,border:`${i(1)} solid ${n.brand.border.primary}`,gridArea:o})}),U=h({vars:{gridArea:""},base:({gridArea:o})=>({paddingInline:m.md,border:`${i(1)} dashed ${n.brand.border.primary}`,gridArea:o})}),v=()=>e.jsxs(l,{cs:N,children:[e.jsx(r,{cs:O({gridArea:"Heading"}),children:e.jsx(x,{size:"medium",children:"Full Width With 3 Columns"})}),e.jsx(B,{area:"FormLeft",text:"Form - Left Third"}),e.jsx(B,{area:"FormCenter",text:"Form - Center Third"}),e.jsx(B,{area:"FormRight",text:"Form - Right Third"})]}),B=({area:o,text:t})=>e.jsxs(r,{cs:U({gridArea:o}),children:[e.jsx(a,{size:"small",fontWeight:"bold",children:t}),Array.from({length:5}).map(()=>e.jsxs(l,{cs:{gridGap:s.sm,marginBlockEnd:i(20)},children:[e.jsx(r,{cs:{backgroundColor:n.surface.default,width:i(120),height:i(12)}}),e.jsx(r,{cs:{border:`${i(1)} solid ${n.brand.border.primary}`,width:"100%",height:i(20)}})]}))]});v.__RAW__=`import * as React from 'react';
...
`,e.jsx(c,{code:I})]})}function Ir(o={}){const{wrapper:t}={...R(),...o.components};return t?e.jsx(t,{...o,children:e.jsx(T,{...o})}):T(o)}export{Ir as default};
