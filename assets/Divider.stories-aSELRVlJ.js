...
`;const T=t({...o.body.lg,fontWeight:k.bold,margin:0}),R=t({...o.body.sm,margin:0}),q=t({margin:`0 0 ${d.md}`}),c=()=>e.jsxs("section",{children:[e.jsx("h3",{className:T,children:"Quote of the Day"}),e.jsx(l,{cs:q}),e.jsx("p",{className:R,children:'"It is not our differences that divide us. It is our inability to recognize, accept, and celebrate those differences." – Audre Lorde'})]});c.__RAW__=`import React from 'react';
...
`,e.jsx(b,{name:"Divider",hideDescription:!0})]})}function N(i={}){const{wrapper:n}={...h(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(v,{...i})}):v(i)}const A={title:"Preview/Divider",component:l,tags:["autodocs"],parameters:{docs:{page:N}}},a={render:m},s={render:c};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  render: BasicExample
