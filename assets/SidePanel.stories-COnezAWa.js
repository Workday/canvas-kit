...
`;const A={viewport:i({height:o(320)}),main:i({alignItems:"center",justifyContent:"center",flexDirection:"column",flex:1,flexBasis:"auto"})},B=()=>{const t=P({onStateTransition:n=>{console.log(`state is: ${n}`)}});return e.jsxs(s,{cs:A.viewport,children:[e.jsxs(a,{model:t,children:[e.jsx(a.ToggleButton,{"aria-label":"Collapse View"}),e.jsx(a.Heading,{hidden:!0,size:"small",children:"Tasks Panel"})]}),e.jsx(s,{as:"main",cs:A.main,children:e.jsx(c,{as:"p",typeLevel:"body.large",children:"Side Panel with a hidden title text."})})]})};B.__RAW__=`import * as React from 'react';
...
`;const p={accentIcon:i({marginInlineEnd:w.md}),pageContainer:i({gap:w.md,height:o(320)}),panelContainer:i({alignItems:"center",padding:k.md}),panelHeading:i({color:b.fg.default}),mainContent:i({alignItems:"center",justifyContent:"center",flexBasis:"auto",flex:1})},F=()=>e.jsxs(s,{cs:p.pageContainer,children:[e.jsx(a,{initialTransitionState:"expanded",children:e.jsxs(s,{cs:p.panelContainer,children:[e.jsx(z,{icon:V,cs:p.accentIcon}),e.jsx(a.Heading,{size:"small",cs:p.panelHeading,children:"Tasks Panel"})]})}),e.jsx(s,{as:"main",cs:p.mainContent,children:e.jsx(c,{as:"p",typeLevel:"body.large",children:"This is the main content section."})})]});F.__RAW__=`import {rocketIcon} from '@workday/canvas-expressive-icons-web';
import {ExpressiveIcon} from '@workday/canvas-kit-react/icon';
import {Flex} from '@workday/canvas-kit-react/layout';
import {SidePanel} from '@workday/canvas-kit-react/side-panel';
import {Text} from '@workday/canvas-kit-react/text';
