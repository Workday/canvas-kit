...
`;const w=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{error:"caution",id:"hint-alert",children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsxs(o.Field,{children:[e.jsxs(o.List,{as:t,name:"crust-alert",onChange:n,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]}),e.jsx(o.Hint,{children:"Deep dish is an extra $2.99."})]})]})};w.__RAW__=`import React from 'react';
...
`;const y=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{error:"error",children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsxs(o.Field,{children:[e.jsxs(o.List,{as:t,name:"crust-error",onChange:n,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]}),e.jsx(o.Hint,{children:"Deep dish is currently sold out."})]})]})};y.__RAW__=`import React from 'react';
...
`;const U={containerStyles:c({backgroundColor:C.surface.contrast.default,padding:$.md}),formFieldStyles:c({legend:{color:C.fg.inverse}})},L=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsx(W,{cs:U.containerStyles,children:e.jsxs(t,{name:"crust-inverse",onChange:n,value:a,children:[e.jsx(t.RadioButton,{variant:"inverse",value:"deep-dish",children:"Deep dish"}),e.jsx(t.RadioButton,{variant:"inverse",value:"thin",children:"Thin"}),e.jsx(t.RadioButton,{variant:"inverse",value:"gluten-free",children:"Gluten free"}),e.jsx(t.RadioButton,{variant:"inverse",value:"cauliflower",children:"Cauliflower"})]})})};L.__RAW__=`import React from 'react';
...
`;const B=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{orientation:"horizontalStart",children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsx(o.Field,{children:e.jsxs(o.List,{as:t,name:"crust-label",onChange:n,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]})})]})};B.__RAW__=`import React from 'react';
...
`;const k=()=>{const[a,r]=d.useState(0),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{children:[e.jsx(o.Label,{as:"legend",children:"Choose Your Pizza Crust"}),e.jsxs(o.List,{as:t,name:"crust-no-value",onChange:n,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]})]})};k.__RAW__=`import React from 'react';
...
`;const S=()=>{const[a,r]=d.useState("deep-dish"),n=d.useRef(null),s=Y=>{const V=Y.currentTarget;V instanceof HTMLInputElement&&r(V.value)},i=()=>{n.current.click()};return e.jsxs(e.Fragment,{children:[e.jsxs(o,{children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsxs(o.List,{as:t,name:"crust-ref",onChange:s,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",ref:n,children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]})]}),e.jsx(O,{onClick:i,children:"Select Gluten Free"})]})};S.__RAW__=`import React from 'react';
...
`;const T=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsx(o.Field,{children:e.jsxs(o.List,{as:t,name:"crust-disabled",onChange:n,value:a,children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,disabled:!0,value:"gluten-free",children:"Gluten free (sold out)"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]})})]})};T.__RAW__=`import React from 'react';
...
`;const z=()=>{const[a,r]=d.useState(""),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(o,{isRequired:!0,children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsxs(o.List,{as:t,name:"crust-required",onChange:n,value:a,"aria-describedby":"choose-crust",children:[e.jsx(o.Input,{as:t.RadioButton,value:"deep-dish",children:"Deep dish"}),e.jsx(o.Input,{as:t.RadioButton,value:"thin",children:"Thin"}),e.jsx(o.Input,{as:t.RadioButton,value:"gluten-free",children:"Gluten free"}),e.jsx(o.Input,{as:t.RadioButton,value:"cauliflower",children:"Cauliflower"})]}),e.jsx(o.Hint,{children:"You must choose a crust"})]})};z.__RAW__=`import React from 'react';
...
`;const p={formfieldInputStyles:c({width:M(200)}),radioGroupLabelTextStyles:c({color:C.fg.default})},E=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(u,{flexDirection:"column",children:[e.jsxs(o,{children:[e.jsx(o.Label,{children:"Choose Your Pizza Crust"}),e.jsx(o.Field,{children:e.jsxs(o.List,{as:t,name:"pizza-crust-custom",onChange:n,cs:p.formfieldInputStyles,value:a,children:[e.jsxs(t.Label,{children:[e.jsx(o.Input,{as:t.Label.Input,value:"deep-dish"}),e.jsx(t.Label.Text,{cs:p.radioGroupLabelTextStyles,children:"Deep dish"})]}),e.jsxs(t.Label,{children:[e.jsx(o.Input,{as:t.Label.Input,value:"gluten-free"}),e.jsx(t.Label.Text,{cs:p.radioGroupLabelTextStyles,children:"Gluten free"})]}),e.jsxs(t.Label,{children:[e.jsx(o.Input,{as:t.Label.Input,value:"cauliflower"}),e.jsx(t.Label.Text,{cs:p.radioGroupLabelTextStyles,children:"Cauliflower"})]})]})})]}),"Value selected: ",a]})};E.__RAW__=`import React from 'react';
...
`;const _=()=>{const[a,r]=d.useState("deep-dish"),n=s=>{const i=s.currentTarget;i instanceof HTMLInputElement&&r(i.value)};return e.jsxs(u,{flexDirection:"column",children:[e.jsxs(o,{as:"fieldset",children:[e.jsx(o.Label,{as:"legend",children:"Choose Your Pizza Crust"}),e.jsxs(u,{gap:"m",children:[e.jsxs(u,{as:"label",gap:"xs",children:[e.jsx(o.Input,{as:D,onChange:n,value:"deep-dish",name:"pizza-crust-standalone",checked:a==="deep-dish"}),"Deep dish"]}),e.jsxs(u,{as:"label",gap:"xs",children:[e.jsx(o.Input,{as:D,onChange:n,value:"gluten-free",checked:a==="gluten-free",name:"pizza-crust-standalone"}),"Gluten free"]})]})]}),"Value selected: ",a]})};_.__RAW__=`import React from 'react';
...
`;function H(a){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...P(),...a.components};return e.jsxs(e.Fragment,{children:[e.jsx(A,{of:K}),`
...
`,e.jsx(q,{name:"RadioGroup",fileName:"/preview-react/"})]})}function X(a={}){const{wrapper:r}={...P(),...a.components};return r?e.jsx(r,{...a,children:e.jsx(H,{...a})}):H(a)}const K={title:"Preview/Inputs/Radio",component:t,tags:["autodocs"],parameters:{docs:{page:X}}},h={render:b},m={render:w},F={render:y},f={render:L},x={render:B},G={render:k},R={render:S},v={render:T},g={render:z},j={render:E},I={render:_};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: BasicExample
