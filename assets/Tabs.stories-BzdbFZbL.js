...
`,e.jsx(t.code,{children:"onSelect"}),` callback. This example is identical to the Basic Example, but with tabs named using
...
}`,...S.parameters?.docs?.source}}};const Wt=["Basic","NamedTabs","RightToLeft","OverflowTabs","DisabledTab","Icons","SinglePanel","AlternativeTabStop","HoistedModel","DynamicTabs"];export{g as AlternativeTabStop,f as Basic,w as DisabledTab,S as DynamicTabs,k as HoistedModel,j as Icons,x as NamedTabs,v as OverflowTabs,y as RightToLeft,I as SinglePanel,Wt as __namedExportsOrder,ae as default};
