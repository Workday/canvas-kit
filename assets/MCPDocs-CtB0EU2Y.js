import{j as e}from"./jsx-runtime-Bu6AqWCO.js";import{useMDXComponents as r}from"./index-3YbjYt95.js";import{ae as c}from"./index-B6_fZJIH.js";import"./index-IfJi-UCQ.js";import"./iframe-C5jHHwC4.js";import"../sb-preview/runtime.js";import"./index-BDZ5T_cP.js";import"./index-CDT9hUPM.js";import"./index-BfFTulA3.js";import"./index-Rq9y6XjC.js";function i(s){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"AI For LLMs/MCP Docs"}),`
`,e.jsx(n.h1,{id:"canvas-kit-mcp",children:"Canvas Kit MCP"}),`
`,e.jsxs(n.p,{children:["This Model Context Protocol (MCP) server exposes Canvas Kit ",e.jsx(n.strong,{children:"upgrade guides"}),", ",e.jsx(n.strong,{children:"design token"})," documentation, ",e.jsx(n.strong,{children:"accessibility guidance"}),", and ",e.jsx(n.strong,{children:"per-component docs with sample code"})," (plus optional interactive previews) to AI assistants."]}),`
...
`,e.jsx(n.li,{children:e.jsx(n.a,{href:"#get-accessibility-guidelines",children:e.jsx(n.code,{children:"get-accessibility-guidelines"})})}),`
...
`,e.jsx(n.li,{children:e.jsxs(n.a,{href:"#accessibility-guidance-docsaccessibility",children:["Accessibility Guidance (",e.jsx(n.code,{children:"docs://accessibility/*"}),")"]})}),`
...
`,e.jsx(n.li,{children:e.jsxs(n.a,{href:"#component-accessibility-sections-docsexamplesslugaccessibility",children:["Component accessibility sections (",e.jsx(n.code,{children:"docs://examples/{slug}/accessibility"}),")"]})}),`
...
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Use cases:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:["Migrating deprecated tokens (",e.jsx(n.code,{children:"bg.*"})," → ",e.jsx(n.code,{children:"surface.*"}),", ",e.jsx(n.code,{children:"text.*"})," → ",e.jsx(n.code,{children:"fg.*"}),", ",e.jsx(n.code,{children:"space.x*"})," → ",e.jsx(n.code,{children:"padding"}),"/",e.jsx(n.code,{children:"gap"}),")"]}),`
`,e.jsx(n.li,{children:"Enabling the Sana Canvas theme"}),`
`,e.jsx(n.li,{children:"Understanding t-shirt size scales for shape, size, padding, and gap"}),`
`,e.jsx(n.li,{children:"Finding historical migration guides (v2→v3, v3→v4, v13→v14)"}),`
`]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Returns:"})," Links to token documentation. Start with the v4.4 current-state reference, then migration guides, color palettes, color roles, contrast guidelines, and per-family token guides."]}),`
`,e.jsx(n.h3,{id:"get-accessibility-guidelines",children:e.jsx(n.code,{children:"get-accessibility-guidelines"})}),`
`,e.jsxs(n.p,{children:["Retrieves Canvas Kit accessibility guidance for a scenario, component, or both. This tool is ",e.jsx(n.strong,{children:"documentation guidance only"}),". It does not scan code or pages, run automated accessibility tests, certify WCAG conformance, or guarantee compliance."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Parameters:"})}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"component"})," (optional) — Canvas Kit component/story slug, such as ",e.jsx(n.code,{children:"checkbox"}),", ",e.jsx(n.code,{children:"table"}),", or ",e.jsx(n.code,{children:"modal"}),"."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"scenario"})," (optional) — Accessibility scenario slug, such as ",e.jsx(n.code,{children:"forms"}),", ",e.jsx(n.code,{children:"tables"}),", ",e.jsx(n.code,{children:"nested-rows"}),", ",e.jsx(n.code,{children:"popups"}),", ",e.jsx(n.code,{children:"aria-live"}),", or ",e.jsx(n.code,{children:"page-structure"}),". Requesting ",e.jsx(n.code,{children:"tables"})," also returns the table pattern pages (expandable/nested/selectable rows, filterable/sortable headers, and tables with form fields)."]}),`
`]}),`
`,e.jsxs(n.p,{children:["At least one of ",e.jsx(n.code,{children:"component"})," or ",e.jsx(n.code,{children:"scenario"})," is required."]}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"Examples:"})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{"scenario": "forms"}
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{"component": "table"}
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{"scenario": "nested-rows"}
`})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{"component": "checkbox", "scenario": "forms"}
`})}),`
`,e.jsxs(n.p,{children:[e.jsx(n.strong,{children:"Returns:"})," A JSON summary plus ",e.jsx(n.code,{children:"resource_link"})," entries for matching ",e.jsx(n.code,{children:"docs://accessibility/{slug}"})," resources. When available, the response also includes ",e.jsx(n.code,{children:"docs://examples/{component}"})," and ",e.jsx(n.code,{children:"docs://examples/{component}/accessibility"}),"."]}),`
...
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Current state:"})," v4.4 token reference (Sana Canvas, t-shirt scales, deprecations)"]}),`
...
`]}),`
`,e.jsxs(n.h3,{id:"accessibility-guidance-docsaccessibility",children:["Accessibility Guidance (",e.jsx(n.code,{children:"docs://accessibility/*"}),")"]}),`
`,e.jsxs(n.p,{children:["URI prefix: ",e.jsx(n.code,{children:"docs://accessibility/*"})]}),`
`,e.jsx(n.p,{children:"Guidance-only accessibility documentation covering:"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsx(n.li,{children:"Overview and general Canvas Kit accessibility principles"}),`
`,e.jsx(n.li,{children:"Forms, page structure, tables (expandable rows, nested rows, selectable rows, filterable and sortable column headers, tables with form fields), popups, ARIA live regions, headers, and side panels"}),`
`,e.jsx(n.li,{children:"Windows High Contrast themes and color contrast"}),`
`]}),`
`,e.jsx(n.p,{children:"These resources do not perform automated validation or provide compliance guarantees."}),`
...
`,e.jsxs(n.h3,{id:"component-accessibility-sections-docsexamplesslugaccessibility",children:["Component accessibility sections (",e.jsx(n.code,{children:"docs://examples/{slug}/accessibility"}),")"]}),`
`,e.jsxs(n.p,{children:["Markdown extracted from a component's exact ",e.jsx(n.code,{children:"## Accessibility"})," section when that section exists in the component MDX docs. Use these with the broader ",e.jsx(n.code,{children:"docs://accessibility/*"})," resources for component-specific guidance."]}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"Accessibility docs"})," live under ",e.jsx(n.a,{href:"https://github.com/Workday/canvas-kit/blob/master/modules/mcp/docs/mdx/accessibility",rel:"nofollow",children:e.jsx(n.code,{children:"modules/docs/mdx/accessibility"})})," and are copied into the MCP package through the ",e.jsx(n.code,{children:"accessibilityFiles"})," manifest."]}),`
