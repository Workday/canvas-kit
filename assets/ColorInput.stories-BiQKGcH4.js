import{j as e}from"./jsx-runtime-Bu6AqWCO.js";import{useMDXComponents as B}from"./index-3YbjYt95.js";import{ae as P}from"./index-Bp1vAbJe.js";import{E as d,c as H}from"./union-Csj3bYC6.js";import{S as M}from"./Specifications-BJokHHEp.js";import{e as i}from"./index-IfJi-UCQ.js";import{F as t}from"./FormField-Dq_eL3Ph.js";import{C as l}from"./ColorInput-T4JGhPAB.js";import{P as T}from"./PrimaryButton-mcxnr6dp.js";import{S as q}from"./TypeLevelComponents-BFh8CuXH.js";import"./iframe-DUz6TVNi.js";import"../sb-preview/runtime.js";import"./index-BDZ5T_cP.js";import"./index-CDT9hUPM.js";import"./index-BfFTulA3.js";import"./index-Rq9y6XjC.js";import"./sparkle-QHHyJsRv.js";import"./types-wqmYQQWa.js";import"./SystemIcon-Bc5FTqSz.js";import"./Svg-CDh6670a.js";import"./px2rem-C0KbprIx.js";import"./components-DIXe_rXl.js";import"./cs-CmRirKzJ.js";import"./StatusIndicator-BmiiDMjj.js";import"./Text-Cdlm4YRv.js";import"./mergeStyles-C3mqUtmC.js";import"./Box-BwSubRt6.js";import"./index-DX07rvw8.js";import"./emotion-element-699e6908.browser.esm-CCgPGf3R.js";import"./useConstant-B_SD0x5s.js";import"./flex-1BnMPfFj.js";import"./grid-DeBl5Muz.js";import"./cornerShape-DO7zpd3K.js";import"./index-DE-upP0k.js";import"./Card-CLZCJsGP.js";import"./ExternalHyperlink-ezvqZYmg.js";import"./Hyperlink-DAuEViNw.js";import"./external-link-ChL2h1Cn.js";import"./SecondaryButton-rEEjUScI.js";import"./BaseButton-D8zYHbxs.js";import"./Button-BuO9pq7_.js";import"./lerna-DjshtMtA.js";import"./CanvasProvider-BTLvcapT.js";import"./index-D-t2nnqG.js";import"./Tooltip-DC2MIugw.js";import"./useTooltip-COXD4t91.js";import"./getTransformFromPlacement-CVuX70VQ.js";import"./useDisclosureModel-ySjWLcPL.js";import"./models-CHTjB2ql.js";import"./useUniqueId-BoA5684E.js";import"./useCloseOnEscape-Pga8fWKh.js";import"./Popper-BRbe_tz9.js";import"./TertiaryButton-GhfgKIvV.js";import"./upperFirst-BXmTrG0i.js";import"./ColorPicker-B3hCckRJ.js";import"./check-Ds6vsrAM.js";import"./Expandable-BSMWoT5r.js";import"./Avatar-Hn8J_kPA.js";import"./chevron-up-CAo1sqci.js";import"./Dialog-Bg-DdY8-.js";import"./Popup-B3eOes-q.js";import"./x-B1faap_l.js";import"./usePopupTarget-KBNzPGUp.js";import"./useInitialFocus-DzxHd3wF.js";import"./useReturnFocus-CL2JvsSp.js";import"./useFocusRedirect-Cqk2nVwG.js";import"./Breadcrumbs-CRhNXeMi.js";import"./useOverflowListTarget-Cqie2m_G.js";import"./useListItemRegister-NCGS7HKL.js";import"./useMount-CAK2BN3_.js";import"./bundle.esm-C4XAbbi1.js";import"./Menu-DT2pOe49.js";import"./OverflowTooltip-CieFzTnq.js";import"./useListItemSelect-C_0Ny6tb.js";import"./chevron-right-small-Ng-H0z5q.js";import"./related-actions-BBat1SFr.js";import"./Flex-CyhOkoOt.js";import"./Table-D9NIGuz3.js";import"./check-small-BqSDQIle.js";import"./TextInput-rOV0Sdab.js";import"./types-DXdjelYI.js";const b=()=>{const[n,r]=i.useState(""),o=a=>{r(a.target.value)};return e.jsxs(t,{children:[e.jsx(t.Label,{children:"Background Color"}),e.jsx(t.Field,{children:e.jsx(t.Input,{as:l,onChange:o,value:n})})]})};b.__RAW__=`import React from 'react';
...
`;const _=()=>{const[n,r]=i.useState(""),[o,a]=i.useState(""),g=y=>{r(y.target.value)},f=y=>{a(y)};return e.jsxs(e.Fragment,{children:[e.jsxs(t,{children:[e.jsx(t.Label,{children:"Background Color"}),e.jsx(t.Field,{children:e.jsx(t.Input,{as:l,onChange:g,onValidColorChange:f,value:n})})]}),e.jsxs(q,{size:"large",children:["Last valid color: ",o]})]})};_.__RAW__=`import React from 'react';
...
`;function E(n){const r={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",p:"p",pre:"pre",...B(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(P,{of:A}),`
...
`,e.jsx(M,{file:"./cypress/component/ColorPicker.spec.tsx",initialSpecs:{type:"file",name:"ColorPicker",children:[{type:"describe",name:"ColorInput",children:[{type:"describe",name:"given the '' example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"describe",name:"when clicked",children:[{type:"it",name:"should be focused"}]},{type:"describe",name:"when provided a 6 digit hex value",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a 3 digit hex",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a hex with a hash",children:[{type:"it",name:"should strip the hash from the hex value"}]},{type:"describe",name:"when provided a hex with more than 6 characters",children:[{type:"it",name:"should truncate the value to a length of 6"}]}]},{type:"describe",name:"given the '' example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"describe",name:"when clicked",children:[{type:"it",name:"should be focused"}]},{type:"describe",name:"when provided a 6 digit hex value",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a 3 digit hex",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a hex with a hash",children:[{type:"it",name:"should strip the hash from the hex value"}]},{type:"describe",name:"when provided a hex with more than 6 characters",children:[{type:"it",name:"should truncate the value to a length of 6"}]}]},{type:"describe",name:"given the '' example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"describe",name:"when clicked",children:[{type:"it",name:"should be focused"}]},{type:"describe",name:"when provided a 6 digit hex value",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a 3 digit hex",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a hex with a hash",children:[{type:"it",name:"should strip the hash from the hex value"}]},{type:"describe",name:"when provided a hex with more than 6 characters",children:[{type:"it",name:"should truncate the value to a length of 6"}]}]},{type:"describe",name:"given the '' example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"describe",name:"when clicked",children:[{type:"it",name:"should be focused"}]},{type:"describe",name:"when provided a 6 digit hex value",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a 3 digit hex",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a hex with a hash",children:[{type:"it",name:"should strip the hash from the hex value"}]},{type:"describe",name:"when provided a hex with more than 6 characters",children:[{type:"it",name:"should truncate the value to a length of 6"}]}]},{type:"describe",name:"given the '' example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"describe",name:"when clicked",children:[{type:"it",name:"should be focused"}]},{type:"describe",name:"when provided a 6 digit hex value",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a 3 digit hex",children:[{type:"it",name:"should reflect the hex value"}]},{type:"describe",name:"when provided a hex with a hash",children:[{type:"it",name:"should strip the hash from the hex value"}]},{type:"describe",name:"when provided a hex with more than 6 characters",children:[{type:"it",name:"should truncate the value to a length of 6"}]}]},{type:"describe",name:"given the `Disabled` example is rendered",children:[{type:"it",name:"should not have any axe errors"},{type:"it",name:"should be disabled"}]}]},{type:"describe",name:"ColorPreview",children:[{type:"describe",name:"given the 'Basic' story is rendered",children:[{type:"it",name:"should not have any axe errors"}]}]},{type:"describe",name:"ColorPicker",children:[{type:"describe",name:"Icon button ColorPicker Popup",children:[{type:"describe",name:"when the SecondaryButton is clicked",children:[{type:"it",name:"should not have any axe errors"},{type:"it",name:"should be open"},{type:"describe",name:"when a swatch is clicked",children:[{type:"it",name:"should have check icon"},{type:"describe",name:"when color reset is clicked",children:[{type:"it",name:"should set the color picker value to the reset color"}]}]},{type:"describe",name:"when a custom color is submitted",children:[{type:"it",name:"should set the selected color to input value"}]}]}]},{type:"describe",name:"Color Input ColorPicker Popup",children:[{type:"describe",name:"when the input is focused",children:[{type:"it",name:"should not have any axe errors"},{type:"it",name:"should be open"},{type:"describe",name:"when a swatch is clicked",children:[{type:"it",name:"should update the color input to the swatch color"},{type:"it",name:"should have check icon"},{type:"describe",name:"when color reset is clicked",children:[{type:"it",name:"should set the color picker value to the reset color"}]}]}]}]},{type:"describe",name:"when the InputInteraction story is loaded",children:[{type:"describe",name:"when input is entered into the color input and user hits enter",children:[{type:"it",name:"should not enter a newline in the textarea"}]}]}]}]},name:"ColorInput"})]})}function D(n={}){const{wrapper:r}={...B(),...n.components};return r?e.jsx(r,{...n,children:e.jsx(E,{...n})}):E(n)}const A={title:"Components/Inputs/Color Picker/Color Input",component:l,tags:["autodocs"],parameters:{docs:{page:D}}},s={render:k},c={render:b},h={render:j},p={render:w},m={render:I},u={render:R},F={render:S},x={render:L},v={render:V},C={render:_};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...C.parameters?.docs?.source}}};const ur=["Caution","Basic","Checked","Disabled","Error","Grow","LabelPosition","RefForwarding","Required","ValidColorChange"];export{c as Basic,s as Caution,h as Checked,p as Disabled,m as Error,u as Grow,F as LabelPosition,x as RefForwarding,v as Required,C as ValidColorChange,ur as __namedExportsOrder,A as default};
