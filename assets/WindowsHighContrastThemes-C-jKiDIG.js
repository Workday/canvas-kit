...
`,e.jsxs(t,{cs:{justifyContent:"space-evenly",paddingBlockEnd:r.md},children:[e.jsx("img",{src:l,alt:"Primary button with outline offset 2 pixels"}),e.jsx("img",{src:f,alt:"Menu item with outline offset -2 pixels"})]}),`
...
users.`]}),`
`,e.jsxs(t,{cs:{justifyContent:"space-evenly",paddingBlockEnd:r.md},children:[e.jsx("img",{src:m,alt:"Check mark images highly visible on white background"}),e.jsx("img",{src:h,alt:"Check mark images have poor contrast on dark background"})]}),`
...
`})}),`
`,e.jsxs(t,{cs:{justifyContent:"space-evenly"},children:[e.jsxs("figure",{style:{margin:"0"},children:[e.jsx("img",{src:p,alt:""}),e.jsx("figcaption",{style:{width:s(370)},children:"Before: The mail icon color has poor contrast on dark backgrounds"})]}),e.jsxs("figure",{style:{margin:"0"},children:[e.jsx("img",{src:u,alt:""}),e.jsx("figcaption",{style:{width:s(370)},children:"After: The mail icon inherits the theme's current color for best contrast"})]})]})]})}function E(o={}){const{wrapper:n}={...c(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(i,{...o})}):i(o)}export{E as default};
