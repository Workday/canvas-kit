...
`;const Y={viewport:a({height:x(320)}),main:a({alignItems:"center",justifyContent:"center",flexDirection:"column",flex:1,flexBasis:"auto"})},W=()=>{const{panelProps:t,labelProps:n,controlProps:r}=m();return e.jsxs(o,{cs:Y.viewport,children:[e.jsxs(s,{...t,onExpandedChange:i=>{console.log(`expanded prop is: ${i?"true":"false"}`)},onStateTransition:i=>{console.log(`Side Panel is ${i}`)},children:[e.jsx(s.ToggleButton,{...r}),e.jsx(_,{...n,children:"Hidden Title"})]}),e.jsx(o,{as:"main",cs:Y.main,children:e.jsx(h,{as:"p",typeLevel:"body.large",children:"Side Panel with a hidden title text."})})]})};W.__RAW__=`import * as React from 'react';
...
`;const G={viewport:a({height:x(320)}),main:a({alignItems:"center",justifyContent:"center",flexDirection:"column",flex:1,flexBasis:"auto"})},q=()=>{const{expanded:t,panelProps:n,labelProps:r,controlProps:i}=m(),l=c=>{console.log(`Side panel is ${c?"expanded":"collapsed"}`)};return e.jsxs(o,{cs:G.viewport,children:[e.jsxs(s,{...n,onExpandedChange:l,children:[e.jsx(s.ToggleButton,{...i}),e.jsx(_,{...r,children:"Hidden Title"})]}),e.jsx(o,{as:"main",cs:G.main,children:e.jsxs(h,{as:"p",typeLevel:"body.large",children:["Side panel is ",t?"expanded":"collapsed","."]})})]})};q.__RAW__=`import * as React from 'react';
...
`;const J={viewport:a({height:x(320)}),main:a({alignItems:"center",justifyContent:"center",flexDirection:"column",flex:1,flexBasis:"auto"})},V=()=>{const{panelProps:t,labelProps:n,controlProps:r}=m(),[i,l]=R.useState("expanded"),c=H=>{l(H)};return e.jsxs(o,{cs:J.viewport,children:[e.jsxs(s,{...t,onStateTransition:c,children:[e.jsx(s.ToggleButton,{...r}),e.jsx(_,{...n,children:"Hidden Title"})]}),e.jsx(o,{as:"main",cs:J.main,children:e.jsxs(h,{as:"p",typeLevel:"body.large",children:["Side panel is ",i,"."]})})]})};V.__RAW__=`import * as React from 'react';
...
`;function Q(t){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",ol:"ol",p:"p",pre:"pre",ul:"ul",...Z(),...t.components};return p||P("InformationHighlight",!1),p.Body||P("InformationHighlight.Body",!0),p.Icon||P("InformationHighlight.Icon",!0),p.Link||P("InformationHighlight.Link",!0),e.jsxs(e.Fragment,{children:[e.jsx(te,{of:se}),`
