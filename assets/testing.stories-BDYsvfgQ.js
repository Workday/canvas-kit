import{j as n}from"./jsx-runtime-Bu6AqWCO.js";import{b as g}from"./index-DKOKnxgv.js";import{c as t,p as l}from"./index-CYsyLHR7.js";import{C as s}from"./CountBadge-BOKKGQQr.js";import{C as p}from"./ComponentStatesTable-jhhL0fUQ.js";import{a as i}from"./cs-DvbI9OYs.js";import"./index-IfJi-UCQ.js";import"./components-BLZqCckY.js";import"./styled-BsZD6Etj.js";import"./emotion-styled.browser.esm-CKlp3yy0.js";import"./emotion-element-699e6908.browser.esm-C2ijowoa.js";import"./useTheme-DY7-Bclm.js";const I={title:"Testing/Indicators/Badge/CountBadge",component:s,parameters:{ReadmePath:"react/badge",chromatic:{disable:!1}}},v=i({base:{padding:l.xs,backgroundColor:t.surface.alt.default},modifiers:{variant:{inverse:{backgroundColor:t.brand.accent.primary}}}}),r={render:()=>n.jsx(p,{columnProps:[{label:"Single Digit",props:{count:1}},{label:"Double Digit",props:{count:23}},{label:"Triple Digit",props:{count:456}},{label:"Greater than 999",props:{count:1e3}},{label:"Custom Limit",props:{count:100,limit:100}}],rowProps:[{label:"Default High Emphasis",props:{}},{label:"Default Low Emphasis",props:{emphasis:"low"}},{label:"Inverse High Emphasis",props:{variant:"inverse"}},{label:"Inverse Low Emphasis",props:{emphasis:"low",variant:"inverse"}}],children:e=>n.jsx("div",{...v({variant:e.variant}),children:n.jsx(s,{...e})})})},h=i({vars:{backgroundColor:""},base:({backgroundColor:e})=>({padding:l.md,backgroundColor:e})}),a={render:()=>{const e=["amber","blue","coral","green","indigo","neutral","orange","magenta","purple","red","slate","teal"],c=["100","200","300","400","500","600","700","800","900"].reverse(),m=e.map(o=>({label:o,props:{emphasis:"low",variant:"inverse",count:1,color:o}})),u=c.map(o=>({label:o,props:{colorScale:o}}));return n.jsx(p,{columnProps:u,rowProps:m,children:({color:o,colorScale:d,...b})=>n.jsx("div",{...h({backgroundColor:g[`${o}${d}`]}),children:n.jsx(s,{...b})})})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...a.parameters?.docs?.source}}};const L=["CountBadgeStates","CountBadgeInverseBgTest"];export{a as CountBadgeInverseBgTest,r as CountBadgeStates,L as __namedExportsOrder,I as default};
