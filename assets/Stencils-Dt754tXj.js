...
defined with a component part will have a higher specificity than other styles.`})})]})]})}function tn(o={}){const{wrapper:n}={...m(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(h,{...o})}):h(o)}function a(o,n){throw new Error("Expected "+(n?"component":"object")+" `"+o+"` to be defined: you likely forgot to import, pass, or provide it.")}export{tn as default};
