...
will add your module as a package dependency in `modules/_canvas-kit-css/package.json`

Once you've published your CSS module as an NPM package, do the following:

1. Import your module in `modules/_canvas-kit-css/index.scss`
