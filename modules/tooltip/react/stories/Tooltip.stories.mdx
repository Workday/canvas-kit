...
formatting. The content will loose all semantic meaning when read by a screen reader. If complex
...
example uses those parts directly while being functionally equivelent to the original basic example.
