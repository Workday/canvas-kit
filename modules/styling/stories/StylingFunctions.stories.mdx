<Meta title='Features/Styling/Styling Functions' />
...
Calc functions are useful for doing basic math operations with CSS `calc()` and variables. They will also wrap
variables automatically in `var()`. 
