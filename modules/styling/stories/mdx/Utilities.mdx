...
const styles = createStyles({
  ...
  '&:hover': {
    // colorSpace.darken(firstColor, fallbackColor, mixinColor, percentage)
    backgroundColor: colorSpace.darken(system.color.brand.accent.primary, brand.primary.darkest, system.color.accent.overlay.mixin, system.opacity.accent.hover)
  }
})
```
...
const styles = createStyles({
  backgroundColor: system.color.brand.accent.primary,
  '&:hover': {
    // colorSpace.hover(firstColor, fallbackColor, colorType)
    backgroundColor: colorSpace.hover(system.color.brand.accent.primary, brand.primary.darkest, 'accent')
  }
})
```
...
const styles = createStyles({
  backgroundColor: system.color.brand.accent.primary,
  '&:hover': {
    // colorSpace.pressed(firstColor, fallbackColor, colorType)
    backgroundColor: colorSpace.pressed(system.color.brand.accent.primary, brand.primary.darkest, 'accent')
  }
})
```
