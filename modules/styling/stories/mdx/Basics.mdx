import {CodeExamplePreview, SymbolDoc, StylePropsTable} from '@workday/canvas-kit-docs';
...
<CodeExamplePreview code={CreateStyles} />
...
<CodeExamplePreview code={CreateVars} />
...
<CodeExamplePreview code={CreateStencil} />
