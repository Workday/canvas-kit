...
`Base` is a low level component that exposes the `cs` prop so that you can quickly apply styles to any in a static way. If our components don't quite fit your styling needs, you can use `Base` to build a fully styled component.
