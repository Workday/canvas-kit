...
> statically styling an element and you will lose the performance benefits.
...
> **Note:** For a more in depth overview, please view our [CreateStyles](/docs/styling-create-styles--docs)
> docs.
...
You should use `createStencil` when styling our components that have complex styles and dynamic
properties.

> **Note:** For a more in depth overview, please view our [Stencil](/docs/styling-stencils--docs)
> docs.
