...
import TabsStoriesMeta from './Tabs.stories';
...
import {OutlineTabs} from './examples/OutlineTabs';
...
Set the `variant` prop of `Tabs` to `outline` to render an outlined style of tabs.

<ExampleCodeBlock code={OutlineTabs} />
