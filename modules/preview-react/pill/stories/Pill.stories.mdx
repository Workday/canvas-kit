...
This component renders an `icon`. This component should only be used when `variant='default'`. By
default this component render a `plusIcon` but it can be overriden.
