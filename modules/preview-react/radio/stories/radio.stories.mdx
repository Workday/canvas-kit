...
Use `StyledRadio` when you want a standalone styled radio input and full control of the behavior and
accessibility.
...
input elements but still want some behavior handled for you.
