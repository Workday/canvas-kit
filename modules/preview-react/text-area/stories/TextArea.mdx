...
<ExampleCodeBlock of={TextAreaStories.Basic} />

### Disabled

Use `TextArea.Field`'s `disabled` prop to prevent users from interacting with the field.

<ExampleCodeBlock of={TextAreaStories.Disabled} />
...
<ExampleCodeBlock of={TextAreaStories.Placeholder} />
...
<ExampleCodeBlock of={TextAreaStories.Required} />
...
<ExampleCodeBlock of={TextAreaStories.RefForwarding} />

### Resize Constraints

Use the `resize` css attribute to restrict resizing of it to certain dimensions.

<ExampleCodeBlock of={TextAreaStories.ResizeConstraints} />
...
<ExampleCodeBlock of={TextAreaStories.Grow} />
...
<ExampleCodeBlock of={TextAreaStories.LabelPositionHorizontal} />

#### Vertical

<ExampleCodeBlock of={TextAreaStories.LabelPositionVertical} />
...
<ExampleCodeBlock of={TextAreaStories.HiddenLabel} />
...
<ExampleCodeBlock of={TextAreaStories.Error} />
...
<ExampleCodeBlock of={TextAreaStories.Alert} />
