...
<Meta title="Preview/Menu/React" component={DeprecatedMenu} />
...
`DeprecatedMenu` renders a styled `<ul role="menu">` element within a
[`Card`](/components/containers/card/) and follows the
...
<ArgsTable of={DeprecatedMenuItem} />
