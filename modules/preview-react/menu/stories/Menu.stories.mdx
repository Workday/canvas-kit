...
[Compound Component](../../docs/mdx/COMPOUND_COMPONENTS.mdx) yet and we would like to change the
...
at the [Menu Stories](https://workday.github.io/canvas-kit/?path=/docs/preview-menu-react--basic).
