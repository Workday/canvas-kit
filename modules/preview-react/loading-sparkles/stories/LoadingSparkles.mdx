...
import * as LoadingSparklesStories from './LoadingSparkles.stories';
...
<ExampleCodeBlock of={LoadingSparklesStories.Basic} />

### Right-to-Left (RTL)

<ExampleCodeBlock of={LoadingSparklesStories.RTL} />
