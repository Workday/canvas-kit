...
`StatusIndicator` is a container component which renders an [`Flex`](/components/layout/flex/#flex)
under the hood to apply spacing evenly between its children. It has a default maximum width of
`200px`.
