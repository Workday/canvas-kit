...
import * as MigrationStories from './MigrationMapping.stories';
...
- [Color Token Migration](#color-token-migration)
  - [Base Color Mapping (1:1 Direct Replacement)](#base-color-mapping-11-direct-replacement)
...
- [Spacing Token Migration](#spacing-token-migration)
- [Shape (Border Radius) Token Migration](#shape-border-radius-token-migration)
- [Typography Token Migration](#typography-token-migration)
  - [Font Family](#font-family)
  - [Font Size](#font-size)
  - [Type Levels (Recommended)](#type-levels-recommended)
  - [Type Variants → Text Colors](#type-variants--text-colors)
  - [Depth (Shadow) Token Migration](#depth-shadow-token-migration)
...
<InformationHighlight>
  <InformationHighlight.Body>
    The tables below provide mapping information for all token levels (base, system, brand) to help
    you migrate your usage.
    <strong>
      For most use cases, we <u>highly recommend</u> migrating to <code>system</code> tokens to make
      future maintaining easier.
    </strong>
  </InformationHighlight.Body>
</InformationHighlight>
