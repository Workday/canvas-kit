...
<InformationHighlight variant="caution" emphasis="high">
  ...
  <InformationHighlight.Body>
    The tokens documented below are deprecated in Canvas Kit and will be removed in v14. They are
    replaced by our new Canvas Tokens Web package. We encourage you to begin moving to our new
    tokens.
  </InformationHighlight.Body>
