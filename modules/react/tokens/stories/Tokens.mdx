import {CodeExamplePreview, InformationHighlight} from '@workday/canvas-kit-docs';
...
<CodeExamplePreview code={Overview} />

## Border Radius

### Usage

<CodeExamplePreview code={BorderRadius} />
...
<CodeExamplePreview code={Colors} />
