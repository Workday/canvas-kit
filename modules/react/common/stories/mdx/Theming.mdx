...
> **Note:** You should only import the CSS variables *once* at the root level of your application. If your application renders within another environment that imports these and sets it, **do not** re import them.
...
you can also use `:dir` [pseudo selector](https://developer.mozilla.org/en-US/docs/Web/CSS/:dir).
