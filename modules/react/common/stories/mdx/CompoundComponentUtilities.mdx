import {CodeExamplePreview, Specifications} from '@workday/canvas-kit-docs';
...
<CodeExamplePreview code={CreateComponent} />
...
<CodeExamplePreview code={CreateModelHook} />
...
<CodeExamplePreview code={CreateContainer} />
...
<CodeExamplePreview code={CreateSubcomponent} />
...
<CodeExamplePreview code={CreateElemPropsHook} />
