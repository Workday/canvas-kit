...
<CodeExamplePreview code={VisibleLiveRegion} />
...
<CodeExamplePreview code={HiddenLiveRegion} />
...
<CodeExamplePreview code={FilterListWithLiveStatus} />
...
<CodeExamplePreview code={TextInputWithLiveError} />
