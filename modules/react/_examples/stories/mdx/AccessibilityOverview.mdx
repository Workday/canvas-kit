...
<figure margin='0'>
  ![Mail icon](/assets/whcm/icons_before.png)
  <figcaption>Before: The mail icon is difficult to see on dark backgrounds</figcaption>
</figure>

<figure margin='0'>
  ![Mail icon](/assets/whcm/icons_after.png)
  <figcaption>After: The mail icon inherits the themes current color</figcaption>
</figure>
</Flex>
