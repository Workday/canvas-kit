...
import {AlternativePanel} from './examples/AlternativePanel';
...
import {OverlayPanel} from './examples/OverlayPanel';
...
<Specifications file="./cypress/component/SidePanel.spec.tsx" name="Side Panel" />
