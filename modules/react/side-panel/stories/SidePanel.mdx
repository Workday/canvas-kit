...
The `modal` variant is for panels that overlay other page content, like an overlay menu. It gives
the panel a default surface color and a shadow (depth 6) to stand out. Use this variant when you
want the side panel to float above your main content, not as part of the page layout.
