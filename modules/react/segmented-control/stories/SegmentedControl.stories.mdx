...
<Meta title="Components/Buttons/Segmented Control/React" component={DeprecatedSegmentedControl} />

# Canvas Kit Segmented Control (deprecated)
...
<ArgsTable of={DeprecatedSegmentedControl} />
