...
Set the `error` prop of the wrapping Form Field to `FormField.ErrorType.Caution` or
`FormField.ErrorType.Error` to set the Color Input to the Caution or Error state, respectively. You
