import {CodeExamplePreview, Specifications, SymbolDoc} from '@workday/canvas-kit-docs';
...
<CodeExamplePreview code={OverflowTabs} />
...
<CodeExamplePreview code={AlternativeTabStop} />
...
<CodeExamplePreview code={SinglePanel} />
...
<CodeExamplePreview code={DynamicTabs} />
