...
`Tabs` is a [compound component](/guides/compound-components/) that allows users to navigate between
...
[hoisting the model](/docs/guides-compound-components--page#configuring-a-model) and provides direct
access to its `state` and `events` outside of the `Tabs` component.
...
pattern called [hoisting the model](/docs/guides-compound-components--page#configuring-a-model).
