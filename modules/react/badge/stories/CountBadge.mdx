...
import {BasicWithLowEmphasis} from './examples/BasicWithLowEmphasis';
import {Inverse} from './examples/Inverse';
import {InverseWithLowEmphasis} from './examples/InverseWithLowEmphasis';
...
<ExampleCodeBlock code={BasicWithLowEmphasis} />
...
Combine the `inverse` variant with `low` emphasis for subtle indicators on dark or accent
backgrounds. Only use this combination on backgrounds with
...
<ExampleCodeBlock code={InverseWithLowEmphasis} />
