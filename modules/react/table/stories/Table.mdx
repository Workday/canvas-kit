...
<ExampleCodeBlock of={TableStories.BasicWithHeading} />

### Right to Left

Table supports right-to-left languages when specified in the CanvasProvider theme.

<ExampleCodeBlock of={TableStories.RightToLeft} />
...
<ExampleCodeBlock of={TableStories.Basic} />
...
<ExampleCodeBlock of={TableStories.FixedColumn} />
