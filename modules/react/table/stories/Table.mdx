...
import { StandardTable } from './examples/StandardTable'
...
If a user needs a standard HTML Table with no [CSS Grid](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_grid_layout) features, then they can use the `BaseTable` component. 

<ExampleCodeBlock code={StandardTable} />
