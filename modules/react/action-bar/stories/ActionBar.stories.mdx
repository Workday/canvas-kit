...
Action Bar is a [compound component](/story/guides-compound-components--page) that contains primary
and secondary actions related to a page or task.
...
[hoisting the model](/docs/guides-compound-components--page#configuring-components).
