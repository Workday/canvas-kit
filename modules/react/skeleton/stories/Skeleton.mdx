...
<ExampleCodeBlock of={SkeletonStories.Basic} />

And here's an example that simulates how that Skeleton might work in practice.

<ExampleCodeBlock of={SkeletonStories.Simulation} />
...
<ExampleCodeBlock of={SkeletonStories.Color} />
...
<ExampleCodeBlock of={SkeletonStories.Text} />

### Header

`Skeleton.Header` renders a placeholder for header content such as headings.

<ExampleCodeBlock of={SkeletonStories.Header} />
...
<ExampleCodeBlock of={SkeletonStories.Shape} />
