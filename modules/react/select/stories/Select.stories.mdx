...
import {FetchingDyanmicItems} from './examples/FetchingDyanmicItems';
...
allows you to pass those items to your model. The `Select` component will first render a placeholder
and then once your items are loaded, render your items.

<ExampleCodeBlock code={FetchingDyanmicItems} />
