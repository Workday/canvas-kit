...
You can register items in two way.

1. An Array of Strings
2. An Array Objects

For information on how to structure your data, you can reference
[registering items](https://workday.github.io/canvas-kit/?path=/docs/features-collections--registering-items)
