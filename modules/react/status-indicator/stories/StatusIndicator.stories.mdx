...
Avoid truncation wherever possible by using shorter text in lozenges.

In the case where truncation is necessary, you should use an `OverflowTooltip`. For the full text to
be accessible when you do this, you should make the tooltip focusable with `tabIndex`.
