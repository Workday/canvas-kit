...
<ExampleCodeBlock of={CheckboxStories.Basic} />

### Inverse

Checkbox with inverse variation

<ExampleCodeBlock of={CheckboxStories.Inverse} />

### Disabled

Set the `disabled` prop of the Checkbox to prevent users from interacting with it.

<ExampleCodeBlock of={CheckboxStories.Disabled} />
...
<ExampleCodeBlock of={CheckboxStories.Indeterminate} />
...
<ExampleCodeBlock of={CheckboxStories.RefForwarding} />
...
<ExampleCodeBlock of={CheckboxStories.LabelPosition} />
...
<ExampleCodeBlock of={CheckboxStories.Required} />
...
<ExampleCodeBlock of={CheckboxStories.Alert} />

#### Error

<ExampleCodeBlock of={CheckboxStories.Error} />
