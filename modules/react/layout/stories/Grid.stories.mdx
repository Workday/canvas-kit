...
allows the parent container to control how its children render.
...
In the example above we nested `Grid` components to created our layout, and we controlled the layout
