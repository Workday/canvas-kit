...
(Tab / Shift + Tab can move focus out of the first popup) and **focus trapping** (focus stays
inside the second popup until it closes). Opening one does not close the other.
