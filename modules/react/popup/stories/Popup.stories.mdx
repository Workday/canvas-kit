...
import {
  ...
  PopupStateComponent,
  PopupEventsComponent,
} from './PopupModel.splitprops.tsx';
...
The `Popup` component is a generic [Compound Component](/docs/guides-compound-components--page) that
is used to build popup UIs that are not already covered by Canvas Kit.
