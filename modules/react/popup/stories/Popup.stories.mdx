...
`as={IconButton}`. This element merges all props provided by the [usePopupTarget](#usepopuptarget)
hook which would be used in place of this component if desired.
