...
/**
 * @deprecated ⚠️ `SwitchProps` in Main has been deprecated and will be removed in a future major version. Please use [`Switch` in Preview](https://workday.github.io/canvas-kit/?path=/docs/preview-inputs-switch--docs) instead.
 */
...
/**
 * @deprecated ⚠️ `Switch` in Main has been deprecated and will be removed in a future major version. Please use [`Switch` in Preview](https://workday.github.io/canvas-kit/?path=/docs/preview-inputs-switch--docs) instead.
 */
