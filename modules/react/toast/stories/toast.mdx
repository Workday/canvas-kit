...
import ToastStoriesMeta from './toast.stories';

<Meta of={ToastStoriesMeta} />
...
The `alt` variant removes the border from the Toast, creating a cleaner appearance while
