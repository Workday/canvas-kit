...
> **Accessibility Note**: The HTML `required` attribute is automatically added to the input field
> and announced by screen readers. Consider adding a note at the top of your form indicating that
> fields marked with an asterisk (\*) are required. This provides context for all users.
