...
export default withSnapshotsEnabled({
  title: 'Testing/React/Buttons/Button/Secondary Button New',
  component: SecondaryButtonNew,
});

export const SecondaryButtonNewStates = (props: {theme?: PartialEmotionCanvasTheme}) => (
    ...
    >
      {props => (
        <Container blue={props.variant === 'inverse'}>
          <SecondaryButtonNew {...props}>Test</SecondaryButtonNew>
        </Container>
      )}
    </ComponentStatesTable>
  </StaticStates>
...
export const SecondaryButtonIconNewStates = (props: {theme?: PartialEmotionCanvasTheme}) => (
  <StaticStates theme={props.theme}>
    <ComponentStatesTable
      rowProps={permutateProps(
        {
    ...
    >
      {props => (
        <Container blue={props.variant === 'inverse'}>
          <SecondaryButtonNew {...props}></SecondaryButtonNew>
        </Container>
      )}
    </ComponentStatesTable>
  </StaticStates>
...
export const SecondaryButtonNewThemedStates = () => (
  <SecondaryButtonNewStates theme={{canvas: customColorTheme}} />
);
