...
<SymbolDoc name="PrimaryButton" hideDescription meta={{hideHeader: true}} />
...
<SymbolDoc name="SecondaryButton" hideDescription meta={{hideHeader: true}} />
...
<SymbolDoc name="TertiaryButton" hideDescription meta={{hideHeader: true}} />
...
<SymbolDoc name="DeleteButton" hideDescription meta={{hideHeader: true}} />
