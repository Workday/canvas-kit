...
Use `type="standalone"` when you need to place a `Hyperlink` outside of paragraph or body text. This
removes the underline. By default, `type` is `"inline"` and links are underlined.
