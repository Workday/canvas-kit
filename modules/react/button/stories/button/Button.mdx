...
The examples below show the `TertiaryButton` with `data-dsr-off` set to `true`.

<ExampleCodeBlock code={TertiaryDSROff} />
...
<Specifications file="./cypress/component/Button.spec.tsx" name="Button" />
