...
import {DeleteInverse} from './examples/DeleteInverse';
...
Delete Buttons also have an `inverse` variant. Use this when you need to place a Delete Button on a
dark or colorful background such as `neutral400`.

<ExampleCodeBlock code={DeleteInverse} />
