...
export interface SecondaryButtonNewProps extends Themeable, GrowthBehavior {
  /**
...
export const SecondaryButtonNew = createComponent('button')({
  displayName: 'SecondaryButtonNew',
  Component: (
    {
      size = 'medium',
      iconPosition = 'start',
    ...
    return (
      <Button
        ref={ref}
        size={size}
        colors={getSecondaryButtonNewColors(variant, theme)}
...
export const getSecondaryButtonNewColors = (
  variant: 'inverse' | undefined,
