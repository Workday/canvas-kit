...
export const v13ButtonColorPropVars = {
  default: createVars(
    'background',
    'border',
    'boxShadowInner',
 ...
 */
export const v13ButtonStencil = createStencil({
  vars: {
    background: '',
    border: '',
    boxShadowInner: '',
  ...
  base: ({background, border, boxShadowInner, boxShadowOuter, label, opacity, borderRadius}) => ({
    ...
    backgroundColor: cssVar(
      v13ButtonColorPropVars.default.background,
      cssVar(background, 'transparent')
    ),
    color: cssVar(v13ButtonColorPropVars.default.label, cssVar(label, system.color.fg.strong)),
    borderWidth: px2rem(1),
    borderStyle: 'solid',
    gap: system.space.x2,
    borderColor: cssVar(v13ButtonColorPropVars.default.border, cssVar(border, 'transparent')),
    cursor: 'pointer',
    display: 'inline-flex',
    boxShadow: 'none',
    alignItems: 'center',
    ...
    borderRadius: cssVar(
      v13ButtonColorPropVars.default.borderRadius,
    ...
    '&:disabled, &:disabled:active, &.disabled': {
      cursor: 'default',
      boxShadow: 'none',
      opacity: cssVar(v13ButtonColorPropVars.default.opacity, cssVar(opacity, system.opacity.full)),
    },
    // Focus Styles
    '&:focus-visible, &.focus': {
      backgroundColor: cssVar(
        v13ButtonColorPropVars.focus.background,
        cssVar(background, 'transparent')
      ),
      borderColor: cssVar(v13ButtonColorPropVars.focus.border, cssVar(border, 'transparent')),
      color: cssVar(v13ButtonColorPropVars.focus.label, cssVar(label, system.color.fg.strong)),
      [systemIconStencil.vars.color]: cssVar(
      ...
      ...focusRing({
        ...
        separation: 2,
        innerColor: cssVar(
          v13ButtonColorPropVars.focus.boxShadowInner,
          cssVar(boxShadowInner, system.color.border.inverse.default)
        ),
        outerColor: cssVar(
          v13ButtonColorPropVars.focus.boxShadowOuter,
    ...
    '&:hover, &.hover': {
      backgroundColor: cssVar(
        v13ButtonColorPropVars.hover.background,
        cssVar(background, system.color.bg.contrast.strong)
      ),
      borderColor: cssVar(v13ButtonColorPropVars.hover.border, cssVar(border, 'transparent')),
      color: cssVar(v13ButtonColorPropVars.hover.label, cssVar(label, system.color.fg.stronger)),
      [systemIconStencil.vars.color]: cssVar(
    ...
    '&:active, &.active': {
      backgroundColor: cssVar(
        v13ButtonColorPropVars.active.background,
        cssVar(background, 'transparent')
      ),
      borderColor: cssVar(v13ButtonColorPropVars.active.border, cssVar(border, 'transparent')),
      color: cssVar(v13ButtonColorPropVars.active.label, cssVar(label, system.color.fg.strong)),
      [systemIconStencil.vars.color]: cssVar(
    ...
    '&:disabled, &.disabled': {
      backgroundColor: cssVar(
        v13ButtonColorPropVars.disabled.background,
        cssVar(background, 'transparent')
      ),
      borderColor: cssVar(v13ButtonColorPropVars.disabled.border, cssVar(border, 'transparent')),
      color: cssVar(v13ButtonColorPropVars.disabled.label, cssVar(label, system.color.fg.strong)),
      [systemIconStencil.vars.color]: cssVar(
