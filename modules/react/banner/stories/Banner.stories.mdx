...
`Banner` is a [compound component](/docs/guides-compound-components--page) used surface important
information and feedback to the user about a task, action, or state.
...
[model](/docs/guides-compound-components--page#models). The model is an object that holds the
`state`, i.e. a description of the current snapshot in time of the component.
