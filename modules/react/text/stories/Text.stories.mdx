...
[style props](/docs/features-style-props--background-example) including spacing props such as
...
`Text` is built on top of [`Box`](/components/layout/box) and supports all of its props in addition
to its own.
