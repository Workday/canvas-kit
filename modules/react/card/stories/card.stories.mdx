...
presentational [compound component](/docs/guides-compound-components--page) used as a building block
for other components such as [Popup](/components/popups/popup/) and
