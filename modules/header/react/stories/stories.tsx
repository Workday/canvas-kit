    ...
    <div className="story">
      ...
      <div className={containerStyle}>
        ...
        >
          ...
          />
          <Avatar onClick={handleAvatarClickTest} altText="Profile" />
          <Button buttonType={Button.Type.Primary}>Download</Button>
        </Header>
      </div>
      <br />
      <div className={containerStyle}>
        ...
        >
          ...
          <IconButton
            ...
            aria-label="Inbox"
          />
          <Button buttonType={Button.Type.Primary}>Logout</Button>
        </Header>
      </div>
      <br />
      <div className={containerStyle}>
  ...
  .add('Header With Custom Breakpoints', () => (
    <div className="story">
      ...
      <Header title="Nav Collapses Earlier" breakpoints={{sm: 320, md: 768, lg: 1280}}>
        {nav}
        <IconButton buttonType={IconButton.Type.Circle} icon={notificationsIcon} />
        <Avatar onClick={handleAvatarClickTest} />
        <Button buttonType={Button.Type.Primary}>Download</Button>
      </Header>
      <Header
