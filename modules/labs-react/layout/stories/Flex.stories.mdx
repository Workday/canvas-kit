...
import {FlexStyle} from './examples/PropTables';
...
In short, use `Flex` when you need a flex container to arrange child elements with flexbox, and use
`Box` when you need a simple container.
...
Nesting `Flex` components allows you to create rows and columns to build layouts.
