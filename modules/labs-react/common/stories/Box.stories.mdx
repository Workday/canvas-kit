...
use Canvas values as you build UI. There are five types of border props: `BoxBorderShorthandProps`,
`BorderColorProps`, `BorderRadiusProps`, `BorderStyleProps`, and `BoxBorderWidthPropsBoxBoxBoxBox`.
