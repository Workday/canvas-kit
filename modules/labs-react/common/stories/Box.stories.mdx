...
component. There are seven flex item props: `flex`, `flexGrow`, `flexShrink`, `flexBasis`,
`justifySelf`, `alignSelf`, and `order`. These props are useful when a component is a child of a
