...
<ExampleCodeBlock of={SearchFormStories.Theming} />

You can also provide more specific theming values by providing specific `SearchThemeAttributes`.

<ExampleCodeBlock of={SearchFormStories.CustomTheme} />
...
<ExampleCodeBlock of={SearchFormStories.RTL} />
