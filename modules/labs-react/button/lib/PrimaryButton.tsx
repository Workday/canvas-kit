...
import {createStyles, createModifiers, cssVar} from '@workday/canvas-kit-styling';
...
export const PrimaryButtonModifiers = createModifiers({
  ...
  variant: {
    inverse: createStyles({
      [buttonVars.default.background]: newTheme.colors.primary.contrast,
      [buttonVars.default.border]: 'transparent',
      ...
      '&:focus-visible, &.focus': {
        [buttonVars.focus.background]: newTheme.colors.primary.contrast,
        [buttonVars.focus.border]: colors.blackPepper400,
        [buttonVars.focus.boxShadowInner]: colors.blackPepper400,
        [buttonVars.focus.boxShadowOuter]: newTheme.colors.primary.contrast,
