...
export interface AiAssistantIngressButtonProps extends Omit<BaseButtonProps, 'size' | 'variant'> {
  toggled?: boolean;
  variant?: 'inverse';
}
...
export const aiAssistantIngressButtonStencil = createStencil({
  ...
  base: {
    ...
    '.wd-icon-ai-assistant-ingress-btn': {
      '.wd-icon-fill': {
        fill: 'url(#ai-assistant-ingress-button-gradient)',
      ...
      >
        <BaseButton.Icon
          ...
          icon={{
            ...
            svg: `<svg class="wd-icon-ai-assistant-ingress-btn" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" >
