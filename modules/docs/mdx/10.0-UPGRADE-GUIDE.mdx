...
We've deprecated `Select` from [Preview](#preview). Please consider using [`Select`](https://workday.github.io/canvas-kit/?path=/story/components-inputs-select--basic) instead.
