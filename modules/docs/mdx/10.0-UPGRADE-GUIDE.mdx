...
- [Codemod](#codemod)
- [Removals](#removals) - [useBanner](#useBanner)
...
We've deprecated `Table` and `TableRow` as well as all of their exported members. Please
use [`Table` in Preview](https://workday.github.io/canvas-kit/?path=/docs/preview-table--basic)
instead.
...
This component also does not havea border around the `Menu` component as the
