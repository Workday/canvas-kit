...
<<<<<<< HEAD:modules/docs/mdx/10.0-UPGRADE-GUIDE.mdx or icons at the start of an input. Please
consider using
...
instead. ======= or icons at the start of an input. Please use
[`InputGroup`](https://workday.github.io/canvas-kit/?path=/story/components-inputs-text-input--icons)
instead.
...
> > > > > > > fc8abdabca2c55aad11f09a8f05570bd55aa3478:modules/docs/mdx/10.0-UPGRADE_GUIDE.mdx

### Table

**PR:** [#2344](https://github.com/Workday/canvas-kit/pull/2344)

<<<<<<< HEAD:modules/docs/mdx/10.0-UPGRADE-GUIDE.mdx We've deprecated `Table` and `TableRow` as well
as all of their exported members. Please use
...
<<<<<<< HEAD:modules/docs/mdx/10.0-UPGRADE-GUIDE.mdx
