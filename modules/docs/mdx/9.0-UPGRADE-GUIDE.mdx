...
been fully removed from Canvas Kit. Instead, please use using the
[Flex](https://workday.github.io/canvas-kit/?path=/docs/components-containers-flex--basic) component with the `gap` prop to set spacing between items.
