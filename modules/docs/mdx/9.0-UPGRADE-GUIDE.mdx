...
- **"Soft-Deprecation"** is now **"Deprecation"**

  - _Deprecation: We add the [@deprecated tag](https://jsdoc.app/tags-deprecated.html) from JSDoc to
    code that we plan to deprecate in the near future. Although you can still consume this code, we
    want consumers to move to a utility or component that is more stable.._

- **"Hard-Deprecation"** is now **"Remove/Removal"**

  - _Removals: Removals are deletions from our codebase and you can no longer consume this
