...
<<<<<<< HEAD
  - [Drawer](#drawer) - [Stack](#Stack)
=======
  - [Drawer](#drawer)
- [Component Updates](#component-updates)
  - [Buttons](#buttons)
>>>>>>> 82b880bf3eb4d359c15b64794181b9a41473c3b5
...
We've [hard-deprecated](#hard-deprecation) `Stack`, `HStack` and `VStack`. These components have
been fully removed from Canvas Kit. Consider using the
[Flex](https://workday.github.io/canvas-kit/?path=/docs/components-containers-flex--basic) component
or .
=======
>>>>>>> 82b880bf3eb4d359c15b64794181b9a41473c3b5
