...
We've promoted `useThemedRing` from our Labs package to our Main package.

🤖 The codemod will update the import for this utility.

### useThemeRTL

We've removed `useThemeRTL` from our Labs package and will no longer support this utility. Instead, we suggest
using [CSS logical properties](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties).
