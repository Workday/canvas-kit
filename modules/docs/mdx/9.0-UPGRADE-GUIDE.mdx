...
**Main:** description of Main package (@workday/canvas-kit-react)

**Preview:** description of Preview package (@workday/canvas-kit-preview-react)

**Labs:** description of Labs package (@workday/canvas-kit-labs-react)
