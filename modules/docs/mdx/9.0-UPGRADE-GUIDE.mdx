...
If you would like to see the differences between `DeprecatedMenu` and the `Menu` compound component,
see [this](https://codesandbox.io/s/deprecatedmenu-to-menu-migration-gwi1ov) codesandbox example.
...
Using the `Menu` component from `main`:
