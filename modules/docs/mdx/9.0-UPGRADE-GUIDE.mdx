...
**Main:** description of Main package (@workday/canvas-kit-react) goes here

**Preview:** description of Preview package (@workday/canvas-kit-preview-react) goes here

**Labs:** description of Labs package (@workday/canvas-kit-labs-react) goes here
...
<Toast mode="dialog">
  ...
  <Toast.Body>
    ...
    <Toast.Link onActionClick={handleActionClick}>View more details</Toast.Link>
  </Toast.Body>
