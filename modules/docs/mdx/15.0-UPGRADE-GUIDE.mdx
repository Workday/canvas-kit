...
- [Component Promotions](#component-promotions)
  ...
  - [Side Panel](#side-panel)
    ...
    - [Code Migration](#code-migration-example)
  - [Segmented Control](#segmented-control)
    - [API Differences](#api-differences-1)
    - [Structure Changes](#structure-changes-1)
    - [Prop Changes](#prop-changes)
    - [Code Migration](#code-migration-1)
...
We've promoted `SidePanel` from [Labs](#labs) to [Main](#main). This replaces the deprecated `SidePanel` that was previously in Main.
...
We've created a new version of the [Switch](https://workday.github.io/canvas-kit/?path=/docs/preview-inputs-switch--docs) component in `Preview`.
...
For more information on our tokens, view our [Tokens](https://workday.github.io/canvas-tokens/?path=/docs/docs-getting-started--docs) documentation.
