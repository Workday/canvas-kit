...
- [Component Updates](#component-updates)
  - [Buttons](#buttons)
    - [Tertiary Button DSR Toggle](#tertiary-button-dsr-toggle)
...
reverts the component to pre-DSR (v14) styles. This allows consumers to more gradually transition
between major versions if needed. By default, this toggle is set to `undefined`. It must be
explicitly set to revert styles. Support for `data-dsr-off` is **temporary** and will become inert
