...
Google provides [helpful resources](https://developers.google.com/tech-writing/overview) for how to write technical documentation. We highly recommend you familiarize yourself with their materials when authoring documentation for Canvas Kit.
...
> **Note:** Refer to [Tabs](/components/containers/tabs/) and [Modal](/components/popups/modal/) for examples of how to write well-structured component documentation.
...
> **Note:** Refer to [Button](/components/buttons/button/) for an example of how to write well-structured component family documentation.
