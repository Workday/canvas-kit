...
<InformationHighlight variant="caution" style={{margin: '1.5rem 0'}}>
  <InformationHighlight.Icon />
  <InformationHighlight.Heading>Important</InformationHighlight.Heading>
  <InformationHighlight.Body>
    While some of our components still support style props, we have made efforts to migrate away
    from Emotion due to its performance cost. We strongly advise to avoid using style props and instead
    use our new styling utilities. If you need to customize styles, please reference our docs on how
    to customize styles.
  </InformationHighlight.Body>
  <InformationHighlight.Link href="https://workday.github.io/canvas-kit/?path=/story/styling-how-to-customize-styles--page">
    View How to Customize Styles
