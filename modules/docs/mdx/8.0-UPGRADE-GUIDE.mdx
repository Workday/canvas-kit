...
We've upgraded Canvas Kit to [React 18](https://reactjs.org/blog/2022/03/29/react-v18.html). React
18 introduces several new features, but the most impactful change is the new
...
including the concurrent features. Without it, React behaves as it did in version 17.
