...
We've [deprecated](#deprecation) `Drawer` and renamed the following items:
...
We've [deprecated](#deprecation) the `Menu` in Preview and renamed the following items:
...
We've [deprecated](#deprecation) `Layout` and `Column` and renamed the following items:
