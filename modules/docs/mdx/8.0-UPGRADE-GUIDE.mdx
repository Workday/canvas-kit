...
We've [promoted](https://github.com/Workday/canvas-kit/issues/1652) the following components in v8:

- `ComponentStatesTable` from `@workday/canvas-kit-labs/common` to
