...
- Container: A container around the Segmented Control component has been added. Since it will be
  ...
  Control component in Main for v8, this update will not impact design or development.

Since it is a net-new component in Preview and no updates will be made to the current Segmented
Control component in Main for v8, this update will not impact design or development.
