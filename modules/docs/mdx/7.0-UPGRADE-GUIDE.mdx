...
Banner is now a [compound component](/docs/guides-compound-components--page) composed of
`Banner.Icon`, `Banner.Label`, and `Banner.ActionText`. This allows direct access to the icon,
...
[createComponent](/docs/guides-creating-compound-components--page#disclosure-component) utility from
our
...
`SegmentedControl` is now a [compound component](/docs/guides-compound-components--page).
