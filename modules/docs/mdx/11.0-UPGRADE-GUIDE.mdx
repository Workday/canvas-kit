...
**PR:** [#XXXX](https://github.com/Workday/canvas-kit/pull/XXXX)

We've removed the `Table` component in main. In its place, we've promoted `Table` from preview to main. This will consist
of a new API that more closely represents a html Table element.
