...
Canvas Kit v11 is a transition into a new
[styling future](https://github.com/Workday/canvas-kit/discussions/2265). Theming and building an in
...
- In this release, we've introduced a
  ...
  compatability. If you want to slowly move off of Emotion as well, you can style styling components
...
In order for all the packages to work in harmony, you must upgrade all Canvas Kit packages that
you're using at the same time, including:
