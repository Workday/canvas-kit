...
these breaking code changes. Simply run:
...
This change is covered by the codemod, but it doesn't currently run on files that don't use the .js,
.jsx, .ts, and .tsx extensions. Those files will have to be updated manually.
...
### Rename Core and Labs Core Module Names to Tokens
