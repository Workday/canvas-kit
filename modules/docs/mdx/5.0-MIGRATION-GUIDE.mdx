...
`Card.Header`. This allows direct access to the header and body elements.
...
// after
<Card>
  <Card.Header id="header-id">Card Title</Card.Header>
  <Card.Body>Card Body</Card.Body>
</Card>
```

The codemod will do it's best to rewrite the JSX to match the new API. It will work if you rename
