...
- 🤖 Variant Updates
  ...
  | `type.variant.mono`    | `{fontWeight: type.properties.fontFamilies.monospace}`                         | variant deprecated, use type properties |
...
instead. This is the only manual update needed for the type updates. Below is an example:
