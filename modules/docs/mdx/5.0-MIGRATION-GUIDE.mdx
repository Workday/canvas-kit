...
return <Link href="https://workday.github.io/canvs-kit">View docs</Link>;

// v5
import {Hyperlink} from '@workday/canvas-kit-labs-react/button';

return <Hyperlink href="https://workday.github.io/canvs-kit">View docs</Hyperlink>;
```
...
const HeadingLink = () => (
  <Hyperlink css={headingLargeStyles} href="https://workday.github.io/canvs-kit">
    View docs
  </Hyperlink>
);
```
