...
>>>>>>> 24a44ff42a9e4424420a61c971515b923e470426
...
- `Hyperlink` and `ExternalHyperlink` now have a `standalone` variant. This removes the underline text decoration for use outside the context of body text.
...
> **Note:** Only use the `standalone` variant in cases where the `<HyperLink>` and `<ExternalHyperlink>` are used outside the context of body text.
