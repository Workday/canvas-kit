...
**PR:** [#3328](https://github.com/Workday/canvas-kit/pull/3328)

As of v14, Canvas Kit required at least version `3.0.0` of Canvas Tokens Web. To upgrade, run the following command:

```sh
yarn upgrade @workday/canvas-tokens-web@^3.0.0
```

or if you're using npm:

```sh
npm install @workday/canvas-tokens-web@^3.0.0
```

> **Note:** If you're using a version of Canvas Tokens Web less than `3.0.0`, you'll need to upgrade to at least `3.0.0` before upgrading to v14.
