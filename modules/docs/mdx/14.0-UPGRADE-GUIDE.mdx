...
migrate to the [Combobox](https://workday.github.io/canvas-kit/?path=/docs/features-combobox--docs)
in `@workday/canvas-kit-react`.
...
The Side Panel component in `@workday/canvas-kit-react/side-panel` has been deprecated. Please use
the new [Side Panel](https://workday.github.io/canvas-kit/?path=/docs/preview-side-panel--docs) for
