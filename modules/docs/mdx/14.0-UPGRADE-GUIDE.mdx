...
revolve around the use of our new brand colors and visual styling updates.

The following components have been updated:

- `Breadcrumbs` - Updated colors and styling to match brand refresh
  - [#3270](https://github.com/Workday/canvas-kit/pull/3270)
  - [#3447](https://github.com/Workday/canvas-kit/pull/3447)
- `Buttons` - New color palette and theming improvements [#3394](https://github.com/Workday/canvas-kit/pull/3394)
- `ColorPicker` (Main) - Visual updates [#3307](https://github.com/Workday/canvas-kit/pull/3307)
- `ColorPicker` (Preview) - Visual updates [#3307](https://github.com/Workday/canvas-kit/pull/3307)
- `InformationHighlight` - Brand color updates [#3443](https://github.com/Workday/canvas-kit/pull/3443)
- `LoadingDots` (Main) - Color and animation updates [#3393](https://github.com/Workday/canvas-kit/pull/3393)
- `Pagination` (Preview) - Styling refresh [#3300](https://github.com/Workday/canvas-kit/pull/3300)
- `Pill` - Visual and color updates [#3446](https://github.com/Workday/canvas-kit/pull/3446)
- `SearchForm` (Labs) - Styling updates [#3303](https://github.com/Workday/canvas-kit/pull/3303)
- `SegmentedControl` (Main) - Brand refresh styling [#3278](https://github.com/Workday/canvas-kit/pull/3278)
- `SegmentedControl` (Preview) - Brand refresh styling [#3278](https://github.com/Workday/canvas-kit/pull/3278)
- `ToolbarDropdownButton` - Visual updates [#3293](https://github.com/Workday/canvas-kit/pull/3293)
- `ToolbarIconButton` - Visual updates [#3293](https://github.com/Workday/canvas-kit/pull/3293)

These updates primarily affect visual appearance and should not require code changes, but may result in visual differences in your application.
