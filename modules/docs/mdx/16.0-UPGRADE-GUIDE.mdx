...
- Block-level padding and inline-level padding for grouped inputs is now **8px** and **4px**,
  respectively. Again, this padding is primarily visible for error and caution states.
