...
> 🤖 The `icon-migration` codemod automates the majority of system icon migration work, but _always_
> review the PR for any remaining icons the codemod could not address, especially dynamic icon
> selection, non-code assets, and heavily customized usages.
