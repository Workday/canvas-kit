...
- Provides a semantic and accessible way to present keyboard keys and shortcuts to users.
...
For more details and advanced usage, refer to the storybook documentation and our example stories
(e.g. for RTL, variants, and testing).
