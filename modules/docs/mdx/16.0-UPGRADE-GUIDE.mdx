...
> **Note:** Canvas Tokens and Canvas System Icons are not included in the Canvas Kit package. You will need to install them separately.
...
We've added a new tool to our MCP to help with icon migrations. This tool will help you find and replace icon usage in your codebase. We've also updated token references for the 4.4.0 release of our tokens package.
