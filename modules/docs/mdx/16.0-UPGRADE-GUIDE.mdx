...
**PR:** [#3960](https://github.com/Workday/canvas-kit/pull/3960), [#4014](https://github.com/Workday/canvas-kit/pull/4014)
...
- **Unchanged:** The `tonal` variant remains the same
...
**PR:** [#3960](https://github.com/Workday/canvas-kit/pull/3960)
...
The `alt` variant uses `system.sana.color.surface.elevated` background with inverse borders, providing visual hierarchy and depth to these components.
