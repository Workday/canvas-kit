...
- `ctaPlacement="bottom" | "end"` — `bottom` (default) stacks the link below heading/body; `end`
  ...
  stacks it below the body when narrower. Grid placement does not reorder DOM children—keyboard tab
  order and screen reader order stay heading, body, then link.
