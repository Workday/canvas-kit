...
We've updated the `Card` component to use the new `cornerShapeStencil` for its rounded corners. This
allows for a more consistent rounded corner style across all components.
