...
- [Component Updates](#component-updates)
  - [Buttons](#buttons)
    - [Delete Button Inverse Variant](#delete-button-inverse-variant)
  - [Card](#card)
...
#### Delete Button Inverse Variant

**PR:** [#4000](https://github.com/Workday/canvas-kit/pull/4000)

We've added an `inverse` variant to the `DeleteButton` component. This variant will invert the
button's styling.
