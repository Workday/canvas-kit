...
<StorybookInformationHighlight
  ...
  description="This guide it meant to help you migrate to Canvas Tokens v3. When we upgrade to Canvas Kit v15, we will update this guide to reflect the new tokens."
