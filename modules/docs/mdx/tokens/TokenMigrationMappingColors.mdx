...
| `colors.cinnamon600`           | `base.red700`                     | `--cnvs-base-palette-red-700`            | sys.color.bg.critical.strong / sys.color.fg.critical.strong                                       |
...
| `colors.cantaloupe200`         | `base.amber200`                   | `--cnvs-base-palette-amber-200`          | sys.color.fg.caution.softer                                                                       |
...
| `colors.watermelon100`         | `base.neutral0`                   | `--cnvs-base-palette-neutral-0`          |                                                                                                   |
| `colors.watermelon200`         | `base.neutral100`                 | `--cnvs-base-palette-neutral-100`        |                                                                                                   |
...
| `colors.blueberry300`          | `base.blue400`                    | `--cnvs-base-palette-blue-400`           | sys.color.bg.primary.default / sys.color.fg.primary.soft                                          |
