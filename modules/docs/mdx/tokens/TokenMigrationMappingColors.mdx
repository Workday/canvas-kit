...
| ------------------ | ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| cinnamon           | "linear-gradient(to bottom right," + colors.cinnamon500 + "," + colors.cinnamon400 + ")"                     | "linear-gradient(to bottom right," + base.red600 + "," + base.red400 + ")"         |
| peach              | "linear-gradient(to bottom right," + colors.peach500 + "," + colors.peach400 + ")"                           | "linear-gradient(to bottom right," + base.coral600 + "," + base.red400 + ")"       |
| chiliMango         | "linear-gradient(to bottom right," + colors.chiliMango500 + "," + colors.chiliMango400 + ")"                 | "linear-gradient(to bottom right," + base.orange500 + "," + base.orange400 + ")"   |
| cantaloupe         | "linear-gradient(to bottom right," + colors.cantaloupe500 + "," + colors.cantaloupe400 + ")"                 | "linear-gradient(to bottom right," + base.amber500 + "," + base.amber400 + ")"     |
| sourLemon          | "linear-gradient(to bottom right," + colors.sourLemon500 + "," + colors.sourLemon400 + ")"                   | "linear-gradient(to bottom right," + base.amber300 + "," + base.amber200 + ")"     |
| juicyPear          | "linear-gradient(to bottom right," + colors.juicyPear500 + "," + colors.juicyPear400 + ")"                   | "linear-gradient(to bottom right," + base.green500 + "," + base.green400 + ")"     |
| kiwi               | "linear-gradient(to bottom right," + colors.kiwi500 + "," + colors.kiwi400 + ")"                             | "linear-gradient(to bottom right," + base.green500 + "," + base.green400 + ")"     |
| greenApple         | "linear-gradient(to bottom right," + colors.greenApple500 + "," + colors.greenApple400 + ")"                 | "linear-gradient(to bottom right," + base.green700 + "," + base.green600 + ")"     |
| watermelon         | "linear-gradient(to bottom right," + colors.watermelon500 + "," + colors.watermelon400 + ")"                 | "linear-gradient(to bottom right," + base.green700 + "," + base.green600 + ")"     |
| jewel              | "linear-gradient(to bottom right," + colors.jewel500 + "," + colors.jewel400 + ")"                           | "linear-gradient(to bottom right," + base.teal600 + "," + base.teal500 + ")"       |
| toothpaste         | "linear-gradient(to bottom right," + colors.toothpaste500 + "," + colors.toothpaste400 + ")"                 | "linear-gradient(to bottom right," + base.azure700 + "," + base.azure500 + ")"     |
| blueberry          | "linear-gradient(to bottom right," + colors.blueberry500 + "," + colors.blueberry400 + ")"                   | `brand.gradients.primary`                                                          |
| plum               | "linear-gradient(to bottom right," + colors.plum500 + "," + colors.plum400 + ")"                             | "linear-gradient(to bottom right," + base.blue700 + "," + base.blue600 + ")"       |
| berrySmoothie      | "linear-gradient(to bottom right," + colors.berrySmoothie500 + "," + colors.berrySmoothie400 + ")"           | "linear-gradient(to bottom right," + base.blue700 + "," + base.blue500 + ")"       |
| blackberry         | "linear-gradient(to bottom right," + colors.blackberry500 + "," + colors.blackberry400 + ")"                 | "linear-gradient(to bottom right," + base.indigo700 + "," + base.indigo500 + ")"   |
| islandPunch        | "linear-gradient(to bottom right," + colors.islandPunch500 + "," + colors.islandPunch400 + ")"               | "linear-gradient(to bottom right," + base.purple700 + "," + base.purple500 + ")"   |
| grapeSoda          | "linear-gradient(to bottom right," + colors.grapeSoda500 + "," + colors.grapeSoda400 + ")"                   | "linear-gradient(to bottom right," + base.purple600 + "," + base.purple500 + ")"   |
| pomegranate        | "linear-gradient(to bottom right," + colors.pomegranate500 + "," + colors.pomegranate400 + ")"               | "linear-gradient(to bottom right," + base.red700 + "," + base.red600 + ")"         |
| fruitPunch         | "linear-gradient(to bottom right," + colors.fruitPunch500 + "," + colors.fruitPunch400 + ")"                 | "linear-gradient(to bottom right," + base.red400 + "," + base.red300 + ")"         |
| rootBeer           | "linear-gradient(to bottom right," + colors.rootBeer600 + "," + colors.rootBeer500 + ")"                     | "linear-gradient(to bottom right," + base.amber950 + "," + base.amber900 + ")"     |
| toastedMarshmallow | "linear-gradient(to bottom right," + colors.toastedMarshmallow500 + "," + colors.toastedMarshmallow400 + ")" | "linear-gradient(to bottom right," + base.amber500 + "," + base.amber400 + ")"     |
| cappuccino         | "linear-gradient(to bottom right," + colors.cappuccino400 + "," + colors.cappuccino300 + ")"                 | "linear-gradient(to bottom right," + base.amber500 + "," + base.amber400 + ")"     |
| licorice           | "linear-gradient(to bottom right," + colors.licorice500 + "," + colors.licorice400 + ")"                     | "linear-gradient(to bottom right," + base.slate800 + "," + base.slate700 + ")"     |
| blackPepper        | "linear-gradient(to bottom right," + colors.blackPepper400 + "," + colors.blackPepper300 + ")"               | "linear-gradient(to bottom right," + base.neutral900 + "," + base.neutral800 + ")" |
...
| ----------------------------------- | ------------------------------ | ------------ |
| `chartingColors[1]`                 | `colors.watermelon200`         | `teal100`    |
| `chartingColors[2]`                 | `colors.watermelon300`         | `green100`   |
| `chartingColors[3]`                 | `colors.jewel200`              | `teal200`    |
| `chartingColors[4]`                 | `colors.jewel300`              | `teal400`    |
| `chartingColors[5]`                 | `colors.plum200`               | `blue200`    |
| `chartingColors[6]`                 | `colors.plum300`               | `blue400`    |
| `chartingColors[7]`                 | `colors.islandPunch200`        | `purple200`  |
| `chartingColors[8]`                 | `colors.islandPunch300`        | `purple500`  |
| `chartingColors[9]`                 | `colors.pomegranate200`        | `magenta100` |
| `chartingColors[10]`                | `colors.pomegranate300`        | `magenta500` |
| `chartingColors[11]`                | `colors.peach200`              | `coral200`   |
| `chartingColors[12]`                | `colors.peach400`              | `coral300`   |
| `chartingColors[13]`                | `colors.cantaloupe200`         | `amber200`   |
| `chartingColors[14]`                | `colors.cantaloupe400`         | `amber300`   |
| `chartingColors[15]`                | `colors.sourLemon200`          | `amber100`   |
| `chartingColors[16]`                | `colors.sourLemon400`          | `amber200`   |
| `chartingColors[17]`                | `colors.watermelon400`         | `green600`   |
| `chartingColors[18]`                | `colors.watermelon500`         | `green700`   |
| `chartingColors[19]`                | `colors.jewel400`              | `teal500`    |
| `chartingColors[20]`                | `colors.jewel500`              | `teal600`    |
| `chartingColors[21]`                | `colors.plum400`               | `blue600`    |
| `chartingColors[22]`                | `colors.plum500`               | `blue700`    |
| `chartingColors[23]`                | `colors.islandPunch400`        | `purple500`  |
| `chartingColors[24]`                | `colors.islandPunch500`        | `purple600`  |
| `chartingColors[25]`                | `colors.pomegranate400`        | `magenta500` |
| `chartingColors[26]`                | `colors.pomegranate600`        | `red700`     |
| `chartingColors[27]`                | `colors.peach500`              | `coral600`   |
| `chartingColors[28]`                | `colors.peach600`              | `coral700`   |
| `chartingColors[29]`                | `colors.cantaloupe500`         | `amber500`   |
| `chartingColors[30]`                | `colors.cantaloupe600`         | `amber600`   |
| `chartingColors[31]`                | `colors.sourLemon500`          | `amber300`   |
| `chartingColors[32]`                | `colors.sourLemon600`          | `amber500`   |
| `chartingColors[33]`                | `colors.greenApple200`         | `green100`   |
| `chartingColors[34]`                | `colors.greenApple300`         | `green200`   |
| `chartingColors[35]`                | `colors.toothpaste200`         | `azure200`   |
| `chartingColors[36]`                | `colors.toothpaste300`         | `azure300`   |
| `chartingColors[37]`                | `colors.blueberry200`          | `blue100`    |
| `chartingColors[38]`                | `colors.blueberry300`          | `blue400`    |
| `chartingColors[39]`                | `colors.berrySmoothie200`      | `indigo200`  |
| `chartingColors[40]`                | `colors.blackberry300`         | `indigo400`  |
| `chartingColors[41]`                | `colors.fruitPunch200`         | `red200`     |
| `chartingColors[42]`                | `colors.fruitPunch300`         | `red300`     |
| `chartingColors[43]`                | `colors.rootBeer200`           | `coral100`   |
| `chartingColors[44]`                | `colors.rootBeer300`           | `coral200`   |
| `chartingColors[45]`                | `colors.toastedMarshmallow200` | `orange100`  |
| `chartingColors[46]`                | `colors.toastedMarshmallow400` | `orange200`  |
| `chartingColors[47]`                | `colors.chiliMango200`         | `coral200`   |
| `chartingColors[48]`                | `colors.chiliMango400`         | `coral300`   |
| `chartingColors[49]`                | `colors.greenApple400`         | `green600`   |
| `chartingColors[50]`                | `colors.greenApple600`         | `green700`   |
| `chartingColors[51]`                | `colors.toothpaste400`         | `azure500`   |
| `chartingColors[52]`                | `colors.toothpaste600`         | `azure800`   |
| `chartingColors[53]`                | `colors.blueberry400`          | `blue600`    |
| `chartingColors[54]`                | `colors.blueberry600`          | `blue800`    |
| `chartingColors[55]`                | `colors.blackberry400`         | `indigo500`  |
| `chartingColors[56]`                | `colors.blackberry600`         | `indigo900`  |
| `chartingColors[57]`                | `colors.fruitPunch400`         | `red400`     |
| `chartingColors[58]`                | `colors.fruitPunch600`         | `red700`     |
| `chartingColors[59]`                | `colors.rootBeer500`           | `amber900`   |
| `chartingColors[60]`                | `colors.rootBeer600`           | `amber950`   |
| `chartingColors[61]`                | `colors.toastedMarshmallow500` | `amber500`   |
| `chartingColors[62]`                | `colors.toastedMarshmallow600` | `amber600`   |
| `chartingColors[63]`                | `colors.chiliMango500`         | `orange500`  |
| `chartingColors[64]`                | `colors.chiliMango600`         | `orange600`  |
| `chartingColors[65]`                | `colors.kiwi200`               | `green100`   |
| `chartingColors[66]`                | `colors.kiwi400`               | `green500`   |
| `chartingColors[67]`                | `colors.berrySmoothie200`      | `indigo200`  |
| `chartingColors[68]`                | `colors.berrySmoothie300`      | `indigo400`  |
| `chartingColors[69]`                | `colors.grapeSoda200`          | `magenta200` |
| `chartingColors[70]`                | `colors.grapeSoda300`          | `magenta400` |
| `chartingColors[71]`                | `colors.cinnamon200`           | `red100`     |
| `chartingColors[72]`                | `colors.cinnamon300`           | `red300`     |
| `chartingColors[73]`                | `colors.sourLemon300`          | `amber200`   |
| `chartingColors[74]`                | `colors.toastedMarshmallow300` | `orange200`  |
| `chartingColors[75]`                | `colors.peach300`              | `coral300`   |
| `chartingColors[76]`                | `colors.cinnamon500`           | `red600`     |
| `chartingColors[77]`                | `colors.cantaloupe300`         | `amber300`   |
| `chartingColors[78]`                | `colors.chiliMango300`         | `coral300`   |
| `chartingColors[79]`                | `colors.kiwi300`               | `green200`   |
| `chartingColors[80]`                | `colors.kiwi500`               | `green500`   |
| `chartingColors[81]`                | `colors.berrySmoothie400`      | `blue500`    |
| `chartingColors[82]`                | `colors.berrySmoothie500`      | `blue700`    |
| `chartingColors[83]`                | `colors.grapeSoda400`          | `purple500`  |
| `chartingColors[84]`                | `colors.grapeSoda500`          | `purple600`  |
| `chartingColors[85]`                | `colors.cinnamon400`           | `red400`     |
| `chartingColors[86]`                | `colors.cinnamon500`           | `red600`     |
| `chartingColorOffsets.barAndColumn` | `colors.watermelon200`         | `teal100`    |
| `chartingColorOffsets.pie`          | `colors.jewel300`              | `teal400`    |
| `chartingColorOffsets.lineAndArea`  | `colors.islandPunch200`        | `purple200`  |
| `chartingColorOffsets.bubble`       | `colors.peach200`              | `coral200`   |
