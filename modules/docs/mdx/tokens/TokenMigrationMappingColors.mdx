...
| `colors.cantaloupe200`         | `base.amber200`                   | `--cnvs-base-palette-amber-200`      | sys.color.bg.caution.soft <br/> sys.color.fg.caution.softer                                               |
| `colors.cantaloupe300`         | `base.amber300`                   | `--cnvs-base-palette-amber-300`      |                                                                                                           |
| `colors.cantaloupe400`         | `base.amber400`                   | `--cnvs-base-palette-amber-400`      | sys.color.bg.caution.default <br/> sys.color.fg.caution.soft <br/> sys.color.border.caution.default       |
