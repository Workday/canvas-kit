...
- [Deprecations](#deprecations)
	...
	- [With No Existing JSDoc Block](#with-no-existing-jsdoc-block)
	- [With Existing JSDoc Block](#with-existing-jsdoc-block)
...
#### With No Existing JSDoc Block

```tsx
/**
 * @deprecated ⚠️ ${ComponentName/Utility} has been deprecated. ${Provide an explanation and/or alternative}.
 */
```

#### With an Existing JSDoc Block

```tsx
/** ${Existing JSDOC code block for Component/Utility}
 * @deprecated ⚠️ ${ComponentName/Utility} has been deprecated. ${Provide an explanation and/or alternative}.
 */
```
