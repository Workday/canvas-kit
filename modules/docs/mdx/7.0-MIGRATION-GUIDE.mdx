...
We've [refactored `ActionBar`](https://github.com/Workday/canvas-kit/pull/1396) and simplified its logic.
...
To consolidate Button APIs, we've removed `IconButton` in favor of `PrimaryButton`, `SecondaryButton`
and `TertiaryButton`.
