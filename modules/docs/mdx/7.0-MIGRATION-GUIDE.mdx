...
- Now all depth will add only `box-shadow` with 2 shadows style and no border.

Also we changed default depth for the next components:

- Card: Depth 2 → Depth 1
- Select Menu, Menu: Depth 2 → Depth 3
- Breadcrumbs Dropdown Menu: Depth 2 → Depth 3
- Combobox: Depth 1 → Depth 3
- Popup: Depth 2 → Depth 5
- Dialog: Depth 2 → Depth 5
- Color Picker Palette, Toast: Depth 2 → Depth 5
- Modal: Depth 2 → Depth 6
- Side Panel (alternate variant): Depth 3 → Depth 6
