...
This guide contains breaking changes made in Canvas Kit v7. Please
...
[example](https://workday.github.io/canvas-kit/?path=/story/examples-pageheader-react--basic) if
you would like to migrate away from `PageHeader`.
