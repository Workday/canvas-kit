...
the usage is very difficult to detect since most people pass a callback that doesn't take
parameters.
...
🤖 The codemod will update all inline guards and callbacks defined like they are in this example. If a guard or
