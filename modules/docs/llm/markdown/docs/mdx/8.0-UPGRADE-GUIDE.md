---
source_file: docs/mdx/8.0-UPGRADE-GUIDE.mdx
live_url: https://workday.github.io/canvas-kit/docs/mdx/8.0-UPGRADE-GUIDE
---
...
the `color` style prop function to apply these two style props, you'll need to update your
...
We've added a new `@workday/canvas-kit-react/testing` slash
