---
source_file: docs/mdx/5.0-UPGRADE-GUIDE.mdx
live_url: https://workday.github.io/canvas-kit/docs/mdx/5.0-UPGRADE-GUIDE
---
...
Consequently, you'll need to update your

// v5

```

🤖 The codemod will update
...
- 🤖 The `beta_Button` export was removed. The codemod will rename the
...
// Re-exporting
 // where `Card` is a re-exported Canvas Kit `Card`
```
...
`Skeleton.Shape`). You only need to
const MySkeleton = () => (
  <Skeleton>
    <SkeletonHeader />
    <SkeletonText />
