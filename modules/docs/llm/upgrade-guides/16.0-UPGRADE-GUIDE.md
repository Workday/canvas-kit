...
1. Install / enable the Canvas Kit MCP server (see the
   [MCP docs](https://workday.github.io/canvas-kit/?path=/docs/ai-for-llms-mcp-docs--docs)).
2. Ask your agent to call `get-canvas-kit-icon-migration`.
3. Follow the returned guides:
   - [Sana Canvas Assets overview](https://workday.github.io/canvas-kit/?path=/docs/guides-icon-migration-sana-canvas-assets-overview--docs)
     (full deprecated → replacement table)
   - [Icon Migration codemod](https://workday.github.io/canvas-kit/?path=/docs/guides-icon-migration-codemod--docs)
