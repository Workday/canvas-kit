...
`base`, `dark`, `darkest`, `light`, `lightest`, and `lighter` via the `CanvasProvider` theme prop.
...
existing usage continues to work. For more information on theming, view our
