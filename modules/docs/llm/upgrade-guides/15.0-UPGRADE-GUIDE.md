...
<<<<<<< HEAD **PR:** [#3727](https://github.com/Workday/canvas-kit/pull/3727)
...
> > > > > > > 9146af2c29b2b1860bac8c13a1156bb1d2849971

## Removals

### Avatar (Deprecated)

<<<<<<< HEAD **PR:** [#3660](https://github.com/Workday/canvas-kit/pull/3660)
...
variants. ======= The deprecated `Avatar` that was previously in `@workday/canvas-kit-react/avatar`
has been removed. This was the older implementation that showed a user icon placeholder and
supported `light`/`dark` variants.
...
The deprecated `SidePanel` that was previously in `@workday/canvas-kit-react/side-control` has been
...
<<<<<<< HEAD **PR:** [#3626](https://github.com/Workday/canvas-kit/pull/3626)
...
that used `SegmentedControl.Button` subcomponents. ======= The deprecated `SegmentedControl` that
was previously in `@workday/canvas-kit-react/segmented-control` has been removed. This was the older
implementation that used `SegmentedControl.Button` subcomponents.
