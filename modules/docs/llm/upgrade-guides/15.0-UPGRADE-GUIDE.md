...
Canvas v15 is optimized to look best when using the latest tokens (v4) and the latest system icons (v4). It is designed to be backwards-compatible with v3 tokens and v3 system icons — nothing should break. But you might see minor imperfections when using v3 system icons when upgrading to v15. In those cases, we recommend upgrading to v4 icons and v4 tokens.
