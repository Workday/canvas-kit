...
```sh npx
@workday/canvas-kit-codemod v15 [path]
```
...
reverts the component to v14 styles. This allows consumers to more gradually transition between
major versions for this component if needed. By default, this toggle is set to `undefined`. It must
be explicitly set to `true` to revert styles. Support for `data-dsr-off` is **temporary** and will
become inert in the next major release.
...
icons `"@workday/canvas-system-icons-web"` and latest version of v4 tokens
`"@workday/canvas-tokens-web"`.

The size of the icons in some components have been updated. This is the reflected in the following
components:
...
We have added a new utility called
[colorSpace](https://workday.github.io/canvas-kit/?path=/docs/styling-utilities--docs#colorspace)
and it has three functions:
[darken](https://workday.github.io/canvas-kit/?path=/docs/styling-utilities--docs#darken),
[hover](https://workday.github.io/canvas-kit/?path=/docs/styling-utilities--docs#hover) and
[pressed](https://workday.github.io/canvas-kit/?path=/docs/styling-utilities--docs#pressed).
...
- **Promote Side Panel**: promoteSidePanel
- **Remove Status Indicator A I Variant**: removeStatusIndicatorAIVariant
- **Replace Form Field Container**: replaceFormFieldContainer
- **Update Card Variant**: updateCardVariant
- **Update Switch To Preview**: updateSwitchToPreview
