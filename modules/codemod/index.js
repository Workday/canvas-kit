...
const {
  ...
  .options({
    ...
    "ignore-pattern": {
      type: "string",
      describe:
        "Ignore files that match a provided glob expression (e.g. **/dist/**)",
  ...
  .command(
    "v5 [path]",
    chalk.gray("Canvas Kit v4 > v5 migration transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
        describe: chalk.gray(
          "The path to execute the transform in (recursively)."
        ),
      });
    }
  )
  .command(
    "v6 [path]",
    chalk.gray("Canvas Kit v5 > v6 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v7 [path]",
    chalk.gray("Canvas Kit v6 > v7 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v8 [path]",
    chalk.gray("Canvas Kit v7 > v8 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v9 [path]",
    chalk.gray("Canvas Kit v8 > v9 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v11 [path]",
    chalk.gray("Canvas Kit v10 > v11 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v12 [path]",
    chalk.gray("Canvas Kit v11 > v12 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v13 [path]",
    chalk.gray("Canvas Kit v12 > v13 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v13.2 [path]",
    chalk.gray("Canvas React Tokens > Canvas Tokens Web v2"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v14 [path]",
    chalk.gray("Canvas Kit v13 > v14 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v15 [path]",
    chalk.gray("Canvas Kit v14 > v15 upgrade transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
  ...
  .command(
    "v15-icons [path]",
    chalk.gray("New system and expressive icons migration transform"),
    (yargs) => {
      yargs.positional("path", {
        type: "string",
        default: ".",
