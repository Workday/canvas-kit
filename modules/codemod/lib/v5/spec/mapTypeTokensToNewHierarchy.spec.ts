...
// describe('Canvas Kit Labs Type Tokens Map Codemod', () => {
//   context.only('when transforming type imported from canvas', () => {
//     it.skip('should properly transform CSS object styles', () => {
//       const input = `
//         import canvas from '@workday/canvas-kit-react/tokens';
...
//   });
//   context('when transforming type hierarchy levels', () => {
//     it.skip('should properly transform any styles you throw into a styled component', () => {
//       const input = `
//         import {space, type} from '@workday/canvas-kit-react/tokens';

//         const Label = styled('span')(
//           {fontFamily: type.body2.fontFamily},
//           type.body2,
//           type.variant.caps,
...
//   context('when transforming type properties', () => {
//     it.skip('should properly transform fontFamily properties', () => {
//       const input = `
...
//     context('when transforming fontSize properties', () => {
//       it.skip('should properly transform fontSize properties from legacy type (main)', () => {
//         const input = `
//           import {type as canvasType} from '@workday/canvas-kit-react/tokens';
...
//           const SectionText = () => (
//             <section>
//               <h2 css={{margin: 0, fontSize: canvasType.h2.fontSize}}>Section Heading</h2>
//               <p css={{fontSize: canvasType.body.fontSize}}>This is sample body text.</p>
//             </section>
//           );
//         `;
...
//           const SectionText = () => (
//             <section>
//               <h2 css={{margin: 0, fontSize: canvasType.properties.fontSizes[24]}}>Section Heading</h2>
//               <p css={{fontSize: canvasType.properties.fontSizes[14]}}>This is sample body text.</p>
//             </section>
//           );
//         `;
...
//       it.skip('should properly transform fontSize properties from beta type (labs and preview)', () => {
//         const input = `
//           import {type as canvasType} from '@workday/canvas-kit-preview-react/tokens';
...
//           const SectionText = () => (
//             <section>
//               <h2 css={{margin: 0, fontSize: canvasType.properties.fontSizes[32]}}>Section Heading</h2>
//               <p css={{fontSize: canvasType.properties.fontSizes[16]}}>This is sample body text.</p>
//             </section>
//           );
//         `;
...
//     it.skip('should properly transform fontWeight properties', () => {
//       const input = `
//           import {type as canvasType} from '@workday/canvas-kit-react/tokens';

//           const headingStyles = {
//             fontWeight: canvasType.h1.fontWeight,
//           };

//           const bodyStyles = {
//             fontWeight: canvasType.body2.fontWeight,
//           };

//           const SectionText = () => (
//             <section>
//               <h2 css={{margin: 0, fontSize: canvasType.h1.fontWeight}}>Section Heading</h2>
//               <p css={{fontSize: canvasType.body2.fontWeight}}>This is sample body text.</p>
//             </section>
//           );
//         `;
...
//           const SectionText = () => (
//             <section>
//               <h2 css={{margin: 0, fontSize: canvasType.properties.fontWeights.bold}}>Section Heading</h2>
//               <p css={{fontSize: canvasType.properties.fontWeights.regular}}>This is sample body text.</p>
//             </section>
//           );
//         `;
