...
storiesOf('React Components|Inputs/Radio/Top Label/Radio Group', module)
...
storiesOf('React Components|Inputs/Radio/Top Label/Radio', module)
  .addParameters({component: Radio})
  .addDecorator(withReadme(README))
  .add('Default', () => (
...
storiesOf('React Components|Inputs/Radio/Left Label/Radio Group', module)
  .addParameters({component: Radio})
  .addDecorator(withReadme(README))
  .add('Default', () => (
...
storiesOf('React Components|Inputs/Radio/Left Label/Radio', module)
  .addParameters({component: Radio})
  .addDecorator(withReadme(README))
  .add('Default', () => (
