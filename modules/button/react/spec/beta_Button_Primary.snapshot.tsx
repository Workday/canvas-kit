...
describe('Button (Primary) Snapshots (beta)', () => {
  ...
  test('renders a large, primary button with an icon', () => {
    const component = renderer.create(
      <Button size={Button.Size.Large} buttonType={Button.Type.Primary} icon={editIcon}>
        Button
      </Button>
    );
    expect(component).toMatchSnapshot();
  ...
  test('renders a large, primary button with a data label', () => {
    const component = renderer.create(
      <Button size={Button.Size.Large} buttonType={Button.Type.Primary} dataLabel={'1:00'}>
        Button
      </Button>
    );
    expect(component).toMatchSnapshot();
  ...
  test('renders a medium, primary button with a data label', () => {
    const component = renderer.create(
      <Button size={Button.Size.Medium} buttonType={Button.Type.Primary} dataLabel={'1:00'}>
        Button
      </Button>
    );
    expect(component).toMatchSnapshot();
  ...
  test('renders a large, growing primary button', () => {
    const component = renderer.create(
      <Button grow={true} size={Button.Size.Large} buttonType={Button.Type.Primary}>
        Button
      </Button>
    );
    expect(component).toMatchSnapshot();
