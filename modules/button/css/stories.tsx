...
storiesOf("Components|Buttons/Button/CSS", module)
  ...
  .add("Primary", () => (
    <div className="story">
      <section>
        ...
        <button
          disabled={true}
          className="wdc-btn wdc-btn-primary wdc-btn-size-l"
        >
          Primary Disabled
        </button>
      ...
      <section>
        <h3>Small Primary</h3>
        <button className="wdc-btn wdc-btn-primary wdc-btn-size-s">
          Primary
        </button>
        <button
          disabled={true}
          className="wdc-btn wdc-btn-primary wdc-btn-size-s"
        >
          Primary Disabled
        </button>
      </section>
  ...
  .add("Delete", () => (
    <div>
      <section>
        <h3>Large Delete</h3>
        <button className="wdc-btn wdc-btn-delete wdc-btn-size-l">
          Delete
        </button>
        <button
          disabled={true}
          className="wdc-btn wdc-btn-delete wdc-btn-size-l"
        >
          Delete Disabled
        </button>
      </section>
      ...
      <section>
        <h3>Small Delete</h3>
        <button className="wdc-btn wdc-btn-delete wdc-btn-size-s">
          Delete
        </button>
        <button
          disabled={true}
          className="wdc-btn wdc-btn-delete wdc-btn-size-s"
        >
          Delete Disabled
        </button>
      </section>
...
storiesOf("CSS/Button/Text", module)
  .addDecorator(withReadme(README))
  .add("Default", () => (
    <div className="story">
      <h3>Large</h3>
  ...
  .add("Inverse", () => (
    <div className="story">
      ...
      <h3>Small Inverse</h3>
      <div css={blueBackground}>
        <button className="wdc-btn-text wdc-btn-text-inverse wdc-btn-text-size-s">
          Text
        </button>
        <button
          disabled={true}
          className="wdc-btn-text wdc-btn-text-inverse wdc-btn-text-size-s"
        >
          Text
        </button>
      </div>
...
storiesOf("CSS/Button/Deprecated", module)
  ...
  .add("Primary", () => (
    <div className="story">
      <h3>Large Primary</h3>
      <button className="wdc-btn-deprecated wdc-btn-primary">
        Primary Button
      </button>
      ...
      <h3>Medium Primary</h3>
      <button className="wdc-btn-deprecated wdc-btn-primary wdc-btn-size-m">
        Primary Button
      </button>
      <button
        disabled={true}
        className="wdc-btn-deprecated wdc-btn-primary wdc-btn-size-m"
      >
        Primary Button
      </button>
      <h3>Small Primary</h3>
      <button className="wdc-btn-deprecated wdc-btn-primary wdc-btn-size-s">
        Primary Button
      </button>
      <button
        disabled={true}
        className="wdc-btn-deprecated wdc-btn-primary wdc-btn-size-s"
      >
        Primary Button
      </button>
  ...
  .add("Secondary", () => (
    <div className="story">
      ...
      <h3>Medium Secondary</h3>
      <button className="wdc-btn-deprecated wdc-btn-size-m">
        Secondary Button
      </button>
      ...
      <h3>Small Secondary</h3>
      <button className="wdc-btn-deprecated wdc-btn-size-s">
        Secondary Button
      </button>
      ...
      <button className="wdc-btn-deprecated wdc-btn-grow">
  ...
  .add("Delete", () => (
    <div className="story">
      <h3>Large Delete</h3>
      <button className="wdc-btn-deprecated wdc-btn-delete">
        Delete Button
      </button>
      ...
      <h3>Medium Delete</h3>
      <button className="wdc-btn-deprecated wdc-btn-delete wdc-btn-size-m">
        Delete Button
      </button>
      <button
        disabled={true}
        className="wdc-btn-deprecated wdc-btn-delete wdc-btn-size-m"
      >
        Delete Button
      </button>
      <h3>Small Delete</h3>
      <button className="wdc-btn-deprecated wdc-btn-delete wdc-btn-size-s">
        Delete Button
      </button>
      <button
        disabled={true}
        className="wdc-btn-deprecated wdc-btn-delete wdc-btn-size-s"
      >
        Delete Button
      </button>
  ...
  .add("Dropdown", () => (
    <div className="story">
      <section>
        <button className="wdc-btn-deprecated wdc-btn-dropdown">
          Dropdown
        </button>
      </section>
    </div>
  ...
  .add("Split", () => (
    <div className="story">
      <section>
        ...
        <div className="wdc-btn-split">
          <button className="wdc-btn-deprecated wdc-btn-split-text">
            Split Button
          </button>
...
storiesOf("Components|Buttons/Button/CSS/Icon Button", module)
  ...
  .add("Square Filled", () => (
    <div className="story">
      ...
      <button
        className="wdc-btn-icon-square-filled"
        aria-label="Activity Stream"
      >
        <SystemIcon icon={activityStreamIcon} />
      </button>
  ...
  .add("Circle Filled", () => (
    <div className="story">
      ...
      <button
        className="wdc-btn-icon-circle-filled"
        aria-label="Activity Stream"
      >
        <SystemIcon icon={activityStreamIcon} />
      </button>
  ...
  .add("Inverse", () => (
    <div className="story">
      ...
      <div css={blueBackground}>
        ...
        <button
          disabled={true}
          className="wdc-btn-icon-inverse"
          aria-label="Activity Stream"
        >
          <SystemIcon icon={activityStreamIcon} />
        </button>
  ...
  .add("Inverse Filled", () => (
    <div className="story">
      ...
      <div css={blueBackground}>
        <button
          className="wdc-btn-icon-inverse-filled"
          aria-label="Activity Stream"
        >
          <SystemIcon icon={activityStreamIcon} />
        </button>
