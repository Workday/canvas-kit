...
storiesOf('CSS/Inputs/Checkbox/Top Label', module)
...
storiesOf('CSS/Inputs/Checkbox/Left Label', module)
  .addParameters({ReadmePath: 'css/checkbox'})
  .add('Default', () => (
...
storiesOf('CSS/Inputs/Checkbox/Checkbox Group/Top Label', module)
  .addParameters({ReadmePath: 'css/checkbox'})
  .add('Default', () => (
    <div className="wdc-form">
...
storiesOf('CSS/Inputs/Checkbox/Checkbox Group/Left Label', module)
  .addParameters({ReadmePath: 'css/checkbox'})
  .add('Default', () => (
    <div className="wdc-form wdc-form-label-position-left">
      <fieldset className="wdc-form-field-wrapper wdc-form-group">
