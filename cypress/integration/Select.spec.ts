    ...
    context(`given the "${story}" story is rendered`, () => {
      ...
      context('when the select button is clicked', () => {
        ...
        context('the menu', () => {
          ...
          it.only('should have an aria-activedescendant attribute with the same value as the id of the first option ("E-mail")', () => {
            cy.findByRole('combobox').should($input => {
              console.log($input);
              const inputEl = $menu.attr('aria-activedescendant');
