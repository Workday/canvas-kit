...
const colorInputStory = 'Labs/Color Picker/Color Picker/React/With Color Input';
const colorPreviewStory = 'Components/Inputs/Color Picker/Color Preview/React';
const colorPickerStory = '/Color Picker/React';
const value = '000000';
...
describe('ColorPicker', () => {
  ...
  ['Default', 'With Color Input', 'With Custom Column Count', 'With Initial Color'].forEach(
    story => {
      context(`given the '${story}' story is rendered`, () => {
        beforeEach(() => {
          h.stories.load('Labs/Color Picker/React', story);
        });
        ...
        it('should have an element with the role "radiogroup"', () => {
          cy.findByRole('radiogroup').should('be.visible');
        });

        it('should have elements with a role of "radio" inside the "radiogroup"', () => {
