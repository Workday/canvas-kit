...
describe('Pagination', () => {
  ...
  context('given the Jump Controls story is rendered', () => {
    beforeEach(() => {
      h.stories.load('Preview/Pagination/React', 'Jump Controls');
    });
  ...
  context('given the Custom Range story is rendered', () => {
    beforeEach(() => {
      h.stories.load('Preview/Pagination/React', 'Custom Range');
    });
  ...
  context('given the GoTo Form story is rendered', () => {
    beforeEach(() => {
      h.stories.load('Preview/Pagination/React', 'Go To Form');
    });
