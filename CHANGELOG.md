...
The changes below include the changes made across all 5.0.0 beta versions (`v5.0.0-beta.0-2`).
...
- Popup accessible example ([#1056](https://github.com/Workday/canvas-kit/pull/1056)) [@csongnguyen](https://github.com/csongnguyen)
